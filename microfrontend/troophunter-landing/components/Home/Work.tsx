    ...
    <>
      <div className="m-[2.5rem_0] gap-[3.125rem] grid w-full mx-auto px-[var(--container-gutter)] max-w-[calc(clamp(89.5rem,94.708994709vw,119.035rem)+var(--container-gutter)*2)] !-mt-[50vh] md:gap-[clamp(1.875rem,1.9841269841vw,2.49375rem)] lg:m-[clamp(4.375rem,4.6296296296vw,5.81875rem)_0]">
          ...
          <div className="w-full aspect-x-1452 aspect-y-890">
            <div className="bg-transparent rounded-[clamp(1.25rem,1.3227513228vw,1.6625rem)] text-[inherit] no-underline relative w-full block lg:rounded-[clamp(1.875rem,1.9841269841vw,2.49375rem)]">
              <div className="relative overflow-hidden grid rounded-[inherit] pt-[calc(var(--aspect-y)/var(--aspect-x)*100%)]">
                <div className="w-full left-0 top-2/4 absolute transform -translate-y-2/4">
                  <picture className="max-w-full leading-[0] block rounded-2xl">
                    <source srcSet="https://a-us.storyblok.com/f/1017006/3720x2280/c7c8f88227/curtin-open-landscape-card.jpg/m/450x330/filters:quality(80) 1x, https://a-us.storyblok.com/f/1017006/3720x2280/c7c8f88227/curtin-open-landscape-card.jpg/m/900x660/filters:quality(80) 2x" media="(min-width: 0px) and (max-width: 479px)" />
                    <source srcSet="https://a-us.storyblok.com/f/1017006/3720x2280/c7c8f88227/curtin-open-landscape-card.jpg/m/932x685/filters:quality(80) 1x, https://a-us.storyblok.com/f/1017006/3720x2280/c7c8f88227/curtin-open-landscape-card.jpg/m/1864x1370/filters:quality(80) 2x" media="(min-width: 480px) and (max-width: 991px)" />
                    <source srcSet="https://a-us.storyblok.com/f/1017006/3720x2280/c7c8f88227/curtin-open-landscape-card.jpg/m/1452x1068/filters:quality(80) 1x, https://a-us.storyblok.com/f/1017006/3720x2280/c7c8f88227/curtin-open-landscape-card.jpg/m/2904x2136/filters:quality(80) 2x" media="(min-width: 992px) and (max-width: 1512px)" />
                    <source srcSet="https://a-us.storyblok.com/f/1017006/3720x2280/c7c8f88227/curtin-open-landscape-card.jpg/m/1905x1402/filters:quality(80) 1x, https://a-us.storyblok.com/f/1017006/3720x2280/c7c8f88227/curtin-open-landscape-card.jpg/m/3810x2804/filters:quality(80) 2x" media="(min-width: 1513px)" />
                    <img className="max-w-full m-0 object-cover w-full h-full rounded-[inherit]" src="https://a-us.storyblok.com/f/1017006/3720x2280/c7c8f88227/curtin-open-landscape-card.jpg/m/450x330/filters:quality(80)" alt="Placeholder"></img>
                  </picture>
                </div>
                <div className="h-auto grid transform -translate-y-2/4 -translate-x-2/4 left-2/4 top-2/4 absolute w-[69.4214876033%]">
                  <picture className="max-w-full leading-[0] block rounded-2xl row-start-1 -col-start-1 row-end-auto col-end-auto">
                    ...
                    <img className="max-w-full m-0 object-cover w-full h-full rounded-[inherit]" src="https://a-us.storyblok.com/f/1017006/1476x843/7c8bacd5b5/open-day-inner.jpg/m/312x178/filters:quality(80)" alt="Placeholder"></img>
                  </picture>
                </div>
              </div>
              <div className="grid content-end md:h-full md:w-full md:left-0 md:bottom-0 md:absolute md:text-white">
                <div className="grid p-[clamp(.75rem,.7936507937vw,.9975rem)_0_0] md:bottom-0 md:sticky md:p-[clamp(1.5rem,1.5873015873vw,1.995rem)_clamp(1.875rem,1.9841269841vw,2.49375rem)]">
                  <h3 className="text-[clamp(1rem,2.0833333333vw,1.33rem)] font-medium leading-[1.5] m-0 order-1 md:text-[inherit] md:text-[clamp(1.25rem,1.3227513228vw,1.6625rem)] md:mt-0 md:mb-0">Curtin Open Day</h3>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="auto-cols-fr gap-[inherit] grid grid-template-areas-a-b">
          <div className="w-full aspect-x-710 aspect-y-890">
            <div className="bg-transparent rounded-[clamp(1.25rem,1.3227513228vw,1.6625rem)] text-[inherit] no-underline relative w-full block lg:rounded-[clamp(1.875rem,1.9841269841vw,2.49375rem)]">
              <div className="relative overflow-hidden grid rounded-[inherit] pt-[calc(var(--aspect-y)/var(--aspect-x)*100%)]">
                <div className="w-full left-0 top-2/4 absolute transform -translate-y-2/4">
                  <picture className="max-w-full leading-[0] block rounded-[20px]">
                    ...
                    <img className="max-w-full m-0 object-cover w-full h-full rounded-[inherit]" src="https://a-us.storyblok.com/f/1017006/1864x2333/f75518e100/sussex-portrait-card.jpg/m/450x677/filters:quality(80)" alt="Placeholder"></img>
                  </picture>
                </div>
              </div>
              <div className="grid content-end md:h-full md:w-full md:left-0 md:bottom-0 md:absolute md:text-white">
                <div className="grid p-[clamp(.75rem,.7936507937vw,.9975rem)_0_0] md:bottom-0 md:sticky md:p-[clamp(1.5rem,1.5873015873vw,1.995rem)_clamp(1.875rem,1.9841269841vw,2.49375rem)]">
                  <h3 className="text-[clamp(1rem,2.0833333333vw,1.33rem)] font-medium leading-[1.5] m-0 order-1 md:text-[inherit] md:text-[clamp(1.25rem,1.3227513228vw,1.6625rem)] md:mt-0 md:mb-0">Sussex Taps</h3>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="relative overflow-hidden grid rounded-[inherit] pt-[calc(var(--aspect-y)/var(--aspect-x)*100%)]">
                <div className="w-full left-0 top-2/4 absolute transform -translate-y-2/4">
                  <picture className="max-w-full leading-[0] block rounded-[20px]">
                    ...
                    <img className="max-w-full m-0 object-cover w-full h-full rounded-[inherit]" src="https://a-us.storyblok.com/f/1017006/1864x2803/5416277cd6/ferox-outer.jpg/m/450x677/filters:quality(80)" alt="Placeholder"></img>
                  </picture>
                </div>
                <div className="h-auto grid transform -translate-y-2/4 -translate-x-2/4 left-2/4 top-2/4 absolute w-[38.0281690141%]">
                  <picture className="max-w-full leading-[0] block rounded-[20px] row-start-1 -col-start-1 row-end-auto col-end-auto">
                    <source srcSet="https://a-us.storyblok.com/f/1017006/1684x3630/aff95687f6/ferox-inner.jpg/m/171x369/filters:quality(80) 1x, https://a-us.storyblok.com/f/1017006/1684x3630/aff95687f6/ferox-inner.jpg/m/342x738/filters:quality(80) 2x" media="(min-width: 0px) and (max-width: 479px)" />
                    <source srcSet="https://a-us.storyblok.com/f/1017006/1684x3630/aff95687f6/ferox-inner.jpg/m/355x765/filters:quality(80) 1x, https://a-us.storyblok.com/f/1017006/1684x3630/aff95687f6/ferox-inner.jpg/m/710x1530/filters:quality(80) 2x" media="(min-width: 480px) and (max-width: 991px)" />
                    <source srcSet="https://a-us.storyblok.com/f/1017006/1684x3630/aff95687f6/ferox-inner.jpg/m/270x582/filters:quality(80) 1x, https://a-us.storyblok.com/f/1017006/1684x3630/aff95687f6/ferox-inner.jpg/m/540x1164/filters:quality(80) 2x" media="(min-width: 992px) and (max-width: 1679px)" />
                    <source srcSet="https://a-us.storyblok.com/f/1017006/1684x3630/aff95687f6/ferox-inner.jpg/m/355x765/filters:quality(80) 1x, https://a-us.storyblok.com/f/1017006/1684x3630/aff95687f6/ferox-inner.jpg/m/710x1530/filters:quality(80) 2x" media="(min-width: 1680px)" />
                    <img className="max-w-full m-0 object-cover w-full h-full rounded-[inherit]" src="https://a-us.storyblok.com/f/1017006/1684x3630/aff95687f6/ferox-inner.jpg/m/171x369/filters:quality(80)" alt="Placeholder"></img>
                  </picture>
                </div>
              </div>
              <div className="grid content-end md:h-full md:w-full md:left-0 md:bottom-0 md:absolute md:text-white">
                <div className="grid p-[clamp(.75rem,.7936507937vw,.9975rem)_0_0] md:bottom-0 md:sticky md:p-[clamp(1.5rem,1.5873015873vw,1.995rem)_clamp(1.875rem,1.9841269841vw,2.49375rem)]">
                  <h3 className="text-[clamp(1rem,2.0833333333vw,1.33rem)] font-medium leading-[1.5] m-0 order-1 md:text-[inherit] md:text-[clamp(1.25rem,1.3227513228vw,1.6625rem)] md:mt-0 md:mb-0">Ferox</h3>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full aspect-x-1452 aspect-y-890">
            <div className="bg-transparent rounded-[clamp(1.25rem,1.3227513228vw,1.6625rem)] text-[inherit] no-underline relative w-full block lg:rounded-[clamp(1.875rem,1.9841269841vw,2.49375rem)]">
              <div className="relative overflow-hidden grid rounded-[inherit] pt-[calc(var(--aspect-y)/var(--aspect-x)*100%)]">
                <div className="w-full left-0 top-2/4 absolute transform -translate-y-2/4">
                  <picture className="max-w-full leading-[0] block rounded-[20px]">
                    <source srcSet="https://a-us.storyblok.com/f/1017006/3720x2280/ac63614d7c/trails-outer.jpg/m/450x330/filters:quality(80) 1x, https://a-us.storyblok.com/f/1017006/3720x2280/ac63614d7c/trails-outer.jpg/m/900x660/filters:quality(80) 2x" media="(min-width: 0px) and (max-width: 479px)" />
                    <source srcSet="https://a-us.storyblok.com/f/1017006/3720x2280/ac63614d7c/trails-outer.jpg/m/932x685/filters:quality(80) 1x, https://a-us.storyblok.com/f/1017006/3720x2280/ac63614d7c/trails-outer.jpg/m/1864x1370/filters:quality(80) 2x" media="(min-width: 480px) and (max-width: 991px)" />
                    ...
                    <img className="max-w-full m-0 object-cover w-full h-full rounded-[inherit]" src="https://a-us.storyblok.com/f/1017006/3720x2280/ac63614d7c/trails-outer.jpg/m/450x330/filters:quality(80)" alt="Placeholder"></img>
                  </picture>
                </div>
                <div className="h-auto grid transform -translate-y-2/4 -translate-x-2/4 left-2/4 top-2/4 absolute w-[69.4214876033%]">
                  <picture className="max-w-full leading-[0] block rounded-[20px] row-start-1 -col-start-1 row-end-auto col-end-auto">
                    ...
                    <img className="max-w-full m-0 object-cover w-full h-full rounded-[inherit]" src="https://a-us.storyblok.com/f/1017006/2582x1427/67a2757f6a/trailswa-video-landscape-frame.jpg/m/312x178/filters:quality(80)" alt="Placeholder"></img>
                  </picture>
                </div>
              </div>
              <div className="grid content-end md:h-full md:w-full md:left-0 md:bottom-0 md:absolute md:text-white">
                <div className="grid p-[clamp(.75rem,.7936507937vw,.9975rem)_0_0] md:bottom-0 md:sticky md:p-[clamp(1.5rem,1.5873015873vw,1.995rem)_clamp(1.875rem,1.9841269841vw,2.49375rem)]">
                  <h3 className="text-[clamp(1rem,2.0833333333vw,1.33rem)] font-medium leading-[1.5] m-0 order-1 md:text-[inherit] md:text-[clamp(1.25rem,1.3227513228vw,1.6625rem)] md:mt-0 md:mb-0">TrailsWA</h3>
                </div>
              </div>
            </div>
          </div>
