...
import FeatureVideoResponsive from '../components/Home/FeatureVideoResponsive';
import Footer from '../components/Home/Footer';
import Hero from '../components/Home/Hero';
import TestimonialsLarge from '../components/Home/TestimonialsLarge';
import WorkWithVideos from '../components/Home/WorkWithVideos';
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`${getTroopHunterPublicUrl()}`}></meta>
        <meta property="og:locale" content="en_US"></meta>
        <meta property="og:image" content={`${getTroopHunterPublicUrl()}/logo/logo-social.png`}></meta>
        ...
        <meta name="twitter:image" content={`${getTroopHunterPublicUrl()}/logo/logo-social.png`}></meta>
