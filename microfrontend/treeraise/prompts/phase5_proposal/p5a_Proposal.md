...
as a `.docx` file, following the exact format described below.

---

## WHAT TO READ FIRST

Before writing anything, extract from the attached files:
...
### SECTION 5 — Why a South Asian Team Makes Sense
...
> The Tech Spec is the primary source. It contains all team assignments, screen counts,
> iteration breakdowns, and hour estimates needed to populate every table.
> Estimated token usage: 20k–50k.

**Save output as:** `context/10_Proposal_<ClientName>.docx`
