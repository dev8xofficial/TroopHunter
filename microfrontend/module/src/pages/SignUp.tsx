  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`${getTroopHunterPublicUrl()}/signup`} />
        ...
        <meta property="og:url" content={`${getTroopHunterPublicUrl()}/signup`} />
      ...
      <div>
        <img className="h-6 lg:h-8" src={`${getTroopHunterPublicUrl()}/logo/logo.svg`} alt="TroopHunter" />
