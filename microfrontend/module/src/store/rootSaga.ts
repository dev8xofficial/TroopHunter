...
export default function* rootSaga(): Generator<AllEffect<Generator<StrictEffect, void, void>>> {
  yield all([
    ...
    watchGetUserSaga(),
    watchGetUserSuccessSaga(),
    watchUpdateUserNameSaga(),
    watchUpdateUserNameSuccessSaga(),
    watchUpdateUserPasswordSaga(),
    watchUpdateUserPasswordSuccessSaga(),
    watchBusinessSaga(),
    watchBusinessSuccessSaga(),
    watchCreateLeadSaga(),
    watchCreateLeadSuccessSaga(),
    watchUpdateLeadSaga(),
    watchUpdateSuccessLeadSaga(),
    watchDeleteLeadSaga(),
    watchDeleteLeadSuccessSaga(),
    watchDeleteLeadsSaga(),
    watchDeleteLeadsSuccessSaga()
  ]);
}
