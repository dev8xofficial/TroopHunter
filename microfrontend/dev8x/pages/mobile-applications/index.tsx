...
import MOBILE from '../../data/mobile-applications/index.d';
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href={'/mobile-applications'} />
        ...
        <meta property="og:url" content={'/mobile-applications'}></meta>
