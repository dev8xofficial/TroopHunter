...
import MVP from '../../data/services-for-early-stage-startups/index.d';
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href={'/services-for-early-stage-startups'} />
        ...
        <meta property="og:url" content={'/services-for-early-stage-startups'}></meta>
