...
import { EmailModal, toggleSmoothModalAtom } from '@repo/components';
...
import PictureContactStyles from '../../components/Surfaces/Picture/index.module.css';
import TextContactStyles from '../../components/Surfaces/TextAnimateUp/index.module.css';
import ContactStyles from '../contact/index.module.css';
    ...
    <>
      ...
      <FooterRevealPageWrap variant="frame">
        ...
        <FooterRevealPageWrap variant="page">
          ...
          <main className={`${ContactStyles['contact-page']}`}>
            {isMobile ? (
              <>
                {/* <div className={ContactStyles['contact-bg-mobile']}>
                  <picture className={`${PictureContactStyles['picture']} ${ContactStyles['contact-image']}`}>
                  ...
                  <video className={ContactStyles['contact-video']} src="https://player.vimeo.com/progressive_redirect/download/900999010/rendition/source/contact-video-square-900-optim%20%28Original%29.mp4?loc=external&amp;signature=..." width="900" height="900" autoPlay muted loop playsInline />
                </div> */}
              </>
            ) : (
              <div className={ContactStyles['contact-bg-desktop']}>
                <picture className={`${PictureContactStyles['picture']} ${ContactStyles['contact-image']}`}>
                ...
                <video className={ContactStyles['contact-video']} src="https://player.vimeo.com/progressive_redirect/download/900999111/rendition/source/contact-video-2268-optim%20%28Original%29.mp4?loc=external&amp;signature=..." width="1512" height="1000" autoPlay muted loop playsInline />
              </div>
            )}
            <div className={ContactStyles['contact-container']}>
              <div className={ContactStyles['contact-content']}>
                <h1 className={ContactStyles['contact-heading']} aria-label="We've got a great feeling about this">
                  {PageData.paragraph}
                </h1>
                <div>
                  <div>
                    <Button variant="secondary" context="contact" endIcon={<RightArrowIcon size={14} className={ContactStyles['button--icon']} />} spanClassName={ContactStyles['contact-button']} onClick={() => toggleModal('contact')}>
            ...
            <footer className={ContactStyles['contact-footer']}>
