  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:image" content={`${process.env.NEXT_PUBLIC_TROOPHUNTER_URL}/logo/logo-social.png`}></meta>
        <meta property="og:image:secure_url" content={`${process.env.NEXT_PUBLIC_TROOPHUNTER_URL}/logo/logo-social.png`}></meta>
        ...
        <meta name="twitter:image" content={`${process.env.NEXT_PUBLIC_TROOPHUNTER_URL}/logo/logo-social.png`}></meta>
