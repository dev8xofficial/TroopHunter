...
const PageData: AboutContent = {
  ...
  footerSocialLinks: [
    { title: 'LinkedIn', href: 'https://www.linkedin.com/in/helloabdul/' },
    // { title: 'Instagram', icon: { name: 'AsteriskIcon', size: 10 }, href: 'https://www.instagram.com/reh.m.an/' },
    // { title: 'Facebook', href: 'https://www.facebook.com/share/15PGxbroKkm/' }
  ]
};
