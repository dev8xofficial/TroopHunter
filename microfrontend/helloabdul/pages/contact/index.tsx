          ...
          <main className={`${styles['contact-page']}`}>
            ...
            <div className={styles['contact-container']}>
              <div className={styles['contact-content']}>
                <h1 className={styles['contact-heading']} aria-label={PageData.paragraph}>
                  {PageData.paragraph}
                </h1>
                <div>
                  <div>
            ...
            <footer className={styles['contact-footer']}>
              <FooterInternationalContents footerSocialLinks={PageData.footerSocialLinks} footerData={PageData.footerData} />
            </footer>
          </main>
