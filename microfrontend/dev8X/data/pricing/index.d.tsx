...
const PRICING: ExpertiseContent[] = [
  {
    slug: '',
    variant: 'green',
    tagText: '',
    ...
    iconCards: {
      ...
      items: [
        ...
        },
        {
          ...
          icon: { name: 'PaintSwatchIcon', size: 22 }
        },
        {
        ...
        },
        {
          ...
          icon: { name: 'GraphAnalysisIcon', size: 26 }
        },
        {
    ...
    contentAsideImageItems: [
      {
        ...
        image: prefixed('/api/images/our-process/2.png')
      },
      {
        title: 'Content and SEO',
        ...
        icon: { name: 'PointerIcon', size: 64 },
        image: prefixed('/api/images/our-process/3.png')
      },
      {
        title: 'Creative and User Interface (UI)',
        ...
        icon: { name: 'PointerIcon', size: 64 },
        image: prefixed('/api/images/our-process/4.png')
      },
      {
        title: 'Website Development',
        ...
        icon: { name: 'PointerIcon', size: 64 },
        image: prefixed('/api/images/our-process/5.png')
      },
      {
        title: 'Website Launch',
        ...
        icon: { name: 'PointerIcon', size: 64 },
        image: prefixed('/api/images/our-process/6.png')
      },
      {
        title: 'Website Maintenance',
        ...
        icon: { name: 'PointerIcon', size: 64 },
        image: prefixed('/api/images/our-process/7.png')
      },
      {
        title: 'Website Evaluation and Improvement',
        ...
        icon: { name: 'ShuffleIcon', size: 64 },
        image: prefixed('/api/images/our-process/8.png')
      }
    ],
    footerMainContent: {
      link: '/contact',
