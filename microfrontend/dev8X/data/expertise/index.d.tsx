    ...
    iconCards: {
      ...
      items: [
        ...
        },
        {
          ...
          icon: { name: 'PostgresqlIcon', size: 24 }
        },
        {
    ...
    contentAsideImageItems: [
      {
        ...
        icon: { name: 'SupabaseIcon', size: 64 },
        image: prefixed('/api/images/work/totalhealthdentalcare/desktop/5.png')
      },
      {
