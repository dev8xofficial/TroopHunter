...
export const WORK_PROJECTS: WorkDetail[] = [
  ...
  },
  {
    ...
    video: {
      ...
      sequences: [prefixed('/videos/work/coral/parts/part-01/parts/part-01/master.m3u8'), prefixed('/videos/work/coral/parts/part-02/master.m3u8'), prefixed('/videos/work/coral/parts/part-03/master.m3u8'), prefixed('/videos/work/coral/parts/part-04/master.m3u8')]
    },
    bgColor: 'blue',
    path: 'coral',
