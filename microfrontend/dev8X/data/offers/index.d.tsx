...
const OFFERS: OffersContent[] = [
      ...
      items: [
        {
          ...
          icon: { name: 'CreditCardIcon', size: 26 }
        },
        // {
        ...
        //   icon: { name: 'SeismometerIcon', size: 22 }
        // },
        // {
        ...
        // },
        {
          ...
          icon: { name: 'PlanetRingIcon', size: 26 }
        },
        {
  ...
  //         icon: { name: 'PieChartIcon', size: 26 }
  //       }
  //     ]
  //   },
  //   contentAsideImageItems: [
