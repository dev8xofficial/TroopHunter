  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <link rel="apple-touch-icon" sizes="180x180" href={prefixed('/apple-touch-icon.svg')} />
        <link rel="icon" type="image/x-icon" href={prefixed('/favicon.svg')} />
        <link rel="icon" type="image/svg+xml" sizes="32x32" href={prefixed('/favicon-32x32.svg')} />
        <link rel="icon" type="image/svg+xml" sizes="16x16" href={prefixed('/favicon-16x16.svg')} />
