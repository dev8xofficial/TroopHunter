...
import PageData from '../../../data/expertise/virtualization/index.d';
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href={`${getDev8xPublicUrl()}/virtualization`} />
        ...
        <meta property="og:url" content={`${getDev8xPublicUrl()}/virtualization`}></meta>
