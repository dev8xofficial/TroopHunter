  ...
  const stepsList = [
    {
      ...
      icon: (
        <svg width="18" height="26" viewBox="0 0 18 26" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[18px] h-[26px]">
          <path d="M14.1443 2.85301L10.4916 9.61193C10.1316 10.3051 10.4516 11.145 11.1715 11.3983L16.1707 13.1447C16.9839 13.438 17.2638 14.4911 16.6906 15.1577L8.37192 24.7561C7.91866 25.2894 7.09213 24.8761 7.17212 24.2096L8.09197 17.6106C8.17196 17.0107 7.83867 16.4641 7.29209 16.2642L1.81298 14.2512C1.11976 14.0112 0.799817 13.1847 1.1331 12.5048L6.49221 1.69321C6.69218 1.27994 7.10545 1 7.57204 1H13.0378C13.9977 1.02666 14.5705 2.05192 14.1306 2.87845L14.1443 2.85301Z" stroke="var(--theme-secondary)" strokeWidth="2" stroke-miterlimit="10" strokeLinecap="round"></path>
        </svg>
      )
    },
    {
      ...
      icon: (
        <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-[28px] w-[28px]">
          <path
            d="M3.5 6.99996H3.52239M3.52239 6.99996H24.4777M3.52239 6.99996C3.5 7.36673 3.5 7.81885 3.5 8.40019V19.6002C3.5 20.907 3.5 21.5595 3.75432 22.0586C3.97802 22.4976 4.33472 22.8555 4.77376 23.0792C5.27241 23.3333 5.9255 23.3333 7.22977 23.3333L20.7703 23.3333C22.0745 23.3333 22.7267 23.3333 23.2253 23.0792C23.6643 22.8555 24.0222 22.4976 24.2459 22.0586C24.5 21.5599 24.5 20.9078 24.5 19.6035L24.5 8.39635C24.5 7.81687 24.5 7.36592 24.4777 6.99996M3.52239 6.99996C3.55033 6.54226 3.61313 6.21748 3.75432 5.94039C3.97802 5.50134 4.33472 5.14465 4.77376 4.92094C5.27289 4.66663 5.92677 4.66663 7.23356 4.66663H20.7669C22.0737 4.66663 22.7262 4.66663 23.2253 4.92094C23.6643 5.14465 24.0222 5.50134 24.2459 5.94039C24.3871 6.21748 24.4498 6.54226 24.4777 6.99996M24.4777 6.99996H24.5M16.3333 12.8333L18.6667 15.1666L16.3333 17.5M11.6667 17.5L9.33333 15.1666L11.6667 12.8333"
    ...
    <>
      ...
      <main className="relative h-full max-h-screen min-h-screen font-medium leading-relaxed transition-colors duration-500 ease-in-out" id="smooth-scrollbar">
        ...
        <section id="hero-section">
          <Hero tagBgColor="#e7d8bc" tagText="Websites" heading={['World-class', 'websites', 'for', 'forward-thinking', 'brands']} image="https://a-us.storyblok.com/f/1017006/3810x2036/6fe5a4bbe5/sussex-3810-x-2039.jpg" />
        </section>
        <section id="problems-section">
          <Problems title="Extraordinary digital products" paragraph="We play to our strengths: For over 14 years we've been ideating, creating and shipping wonderful things on the internet." stepsList={stepsList} />
        </section>
