  ...
  const stepsList = [
    {
      ...
      icon: (
        <svg width="18" height="26" viewBox="0 0 18 26" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[18px] h-[26px]">
          <path d="M14.1443 2.85301L10.4916 9.61193C10.1316 10.3051 10.4516 11.145 11.1715 11.3983L16.1707 13.1447C16.9839 13.438 17.2638 14.4911 16.6906 15.1577L8.37192 24.7561C7.91866 25.2894 7.09213 24.8761 7.17212 24.2096L8.09197 17.6106C8.17196 17.0107 7.83867 16.4641 7.29209 16.2642L1.81298 14.2512C1.11976 14.0112 0.799817 13.1847 1.1331 12.5048L6.49221 1.69321C6.69218 1.27994 7.10545 1 7.57204 1H13.0378C13.9977 1.02666 14.5705 2.05192 14.1306 2.87845L14.1443 2.85301Z" stroke="var(--theme-secondary)" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"></path>
        </svg>
      )
    },
    {
