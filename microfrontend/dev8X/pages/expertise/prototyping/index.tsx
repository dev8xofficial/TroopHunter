...
import PageData from '../../../data/expertise/prototyping/index.d';
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href={`${getDev8xPublicUrl()}/prototyping`} />
        ...
        <meta property="og:url" content={`${getDev8xPublicUrl()}/prototyping`}></meta>
      ...
      <FooterRevealPageWrap variant="frame">
        ...
        <FooterRevealPageWrap variant="page">
          <main className={`${styles['expertise-single']} container-full`}>
            <Hero variant="blue" tagText="Prototyping" heading="Turn your ideas into digital prototypes" icon={<MagicWandIcon width="120" />} />
