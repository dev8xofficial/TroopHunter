...
import PageData from '../../../data/expertise/design-systems/index.d';
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href={`${getDev8xPublicUrl()}/design-systems`} />
        ...
        <meta property="og:url" content={`${getDev8xPublicUrl()}/design-systems`}></meta>
