      ...
      <FooterRevealPageWrap variant="frame">
        ...
        <FooterRevealPageWrap variant="page">
          ...
          <main className={`${styles['expertise-single']} container-full`}>
            <Hero tagText="WordPress CMS" heading="Award-winning WordPress websites" image="https://a-us.storyblok.com/f/1017006/3810x2036/6fe5a4bbe5/sussex-3810-x-2039.jpg" />
            <div>
              <ModularBlocks>
                <IconCards title="WordPress experts" paragraph="15 years’ experience of building with WordPress – the right way." IconCardsItems={PageData.IconCardsItems} />
