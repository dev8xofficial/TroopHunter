...
import PageData from '../../../data/expertise/ansible-web-servers/index.d';
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href={`${getDev8xPublicUrl()}/ansible-web-servers`} />
        ...
        <meta property="og:url" content={`${getDev8xPublicUrl()}/ansible-web-servers`}></meta>
