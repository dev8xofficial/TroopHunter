...
import PageData from '../../../data/expertise/user-research-validation/index.d';
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href={`${getDev8xPublicUrl()}/user-research-validation`} />
        ...
        <meta property="og:url" content={`${getDev8xPublicUrl()}/user-research-validation`}></meta>
