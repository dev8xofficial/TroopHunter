      ...
      <FooterRevealPageWrap variant="frame">
        ...
        <FooterRevealPageWrap variant="page">
          ...
          <main className={`${styles['expertise-single']} container-full`}>
            <Hero tagText="Data Visualisation & Storytelling" heading="High impact data visualisations & storytelling" image="https://a-us.storyblok.com/f/1017006/3810x2036/6fe5a4bbe5/sussex-3810-x-2039.jpg" />
            <div>
              <ModularBlocks>
                <IconCards title="Information is beautiful" paragraph="Unique interfaces, narratives and experiences powered by your data." IconCardsItems={PageData.IconCardsItems} />
