...
const Contact: React.FC = (): JSX.Element => {
  const stepsList = [
    {
      ...
      icon: (
        <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          ></path>
          <path d="M4.7124 17.3658V6.5108C4.7124 5.0158 6.09906 3.79163 7.82156 3.79163H18.1782C19.8899 3.79163 21.2874 5.00497 21.2874 6.5108V17.3658" stroke="var(--theme-secondary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
        </svg>
      )
    },
    {
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M10.3599 14.84L11.0399 15.99C11.3399 16.49 11.7599 16.9 12.2699 17.19C12.7799 17.48 13.3499 17.63 13.9299 17.63H20.9899" stroke="var(--theme-secondary)" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"></path> <path d="M3 6.37H3.35999C3.93999 6.37 4.50999 6.52 5.01999 6.81C5.52999 7.1 5.95 7.51001 6.25 8.01001L6.92001 9.13" stroke="var(--theme-secondary)" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"></path>{' '}
          <path d="M3 17.63H3.35999C3.93999 17.63 4.50999 17.48 5.01999 17.19C5.52999 16.9 5.95 16.49 6.25 15.99L10.98 8.01001C11.28 7.51001 11.7 7.1 12.21 6.81C12.72 6.52 13.29 6.37 13.87 6.37H20.93" stroke="var(--theme-primary)" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"></path> <path d="M17.6099 14.25L20.9799 17.62L17.6099 20.99" stroke="var(--theme-secondary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
          <path d="M17.6099 3L20.9799 6.38L17.6099 9.75" stroke="var(--theme-secondary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
        </svg>
      )
    },
    {
      ...
      icon: (
        <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M18.1416 3.5H20.2999C22.6099 3.5 24.4999 5.39001 24.4999 7.70001V9.695" stroke="var(--theme-primary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
          <path d="M3.5 9.74167V7.70001C3.5 5.39001 5.39001 3.5 7.70001 3.5H9.70668" stroke="var(--theme-primary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
          <path d="M9.74167 24.5H7.70001C5.39001 24.5 3.5 22.61 3.5 20.3V18.2117" stroke="var(--theme-primary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
          <path d="M24.4998 18.2117V20.3C24.4998 22.61 22.6098 24.5 20.2998 24.5H18.2231" stroke="var(--theme-primary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
          <path d="M9.7998 8.8783V10.9783" stroke="var(--theme-secondary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
          <path d="M18.1997 8.8783V10.9783" stroke="var(--theme-secondary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
          <path d="M13.9997 10.4532V14.1399C13.9997 14.4666 13.848 14.7699 13.5914 14.9682L12.9497 15.4699" stroke="var(--theme-secondary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
          <path d="M16.9048 18.69C16.2398 19.5416 15.2015 20.09 14.0465 20.09C12.8915 20.09 11.7598 19.495 11.1064 18.585" stroke="var(--theme-secondary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
        </svg>
      )
    },
    {
  ...
  return (
    <>
      ...
      <main className="relative h-full max-h-screen min-h-screen font-medium leading-relaxed transition-colors duration-500 ease-in-out bg-[#efe3ff]" id="smooth-scrollbar">
        <Header />
        <section id="hero-section">
          <Hero tagBgColor="#b488f1" tagText="Data Visualisation & Storytelling" heading={['High', 'impact,', 'data', 'visualisations', '&', 'storytelling']} image="https://a-us.storyblok.com/f/1017006/3810x2038/2276c88ac5/surveillancewatchexpertise.jpg" />
        </section>
        <section id="problems-section">
          <Problems title="Information is beautiful" paragraph="Unique interfaces, narratives and experiences powered by your data." stepsList={stepsList} />
        </section>
