  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href={`${getDev8xPublicUrl()}/data-visualisation`} />
        ...
        <meta property="og:url" content={`${getDev8xPublicUrl()}/data-visualisation`}></meta>
      ...
      <FooterRevealPageWrap variant="frame">
        ...
        <FooterRevealPageWrap variant="page">
          <main className={`${styles['expertise-single']} container-full`}>
            <Hero variant="purple" tagText="Data Visualisation & Storytelling" heading="Compelling data storytelling through impactful visualisations" icon={<DataIcon width="120" />} />
