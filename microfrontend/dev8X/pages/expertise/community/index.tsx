      ...
      <FooterRevealPageWrap variant="frame">
        ...
        <FooterRevealPageWrap variant="page">
          ...
          <main className={`${styles['expertise-single']} container-full`}>
            <Hero tagText="Community" heading="Interactive, purposeful experiences" image="https://a-us.storyblok.com/f/1017006/3810x2036/6fe5a4bbe5/sussex-3810-x-2039.jpg" />
            <div>
              <ModularBlocks>
                <IconCards title="A force for good" paragraph="Blending award-winning UX, delightful design, and meaningful messages, our world-class digital products continue to serve the community." IconCardsItems={PageData.IconCardsItems} />
