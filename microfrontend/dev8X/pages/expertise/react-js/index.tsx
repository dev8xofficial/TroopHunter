...
import PageData from '../../../data/expertise/react-js/index.d';
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href={`${getDev8xPublicUrl()}/react-js`} />
        ...
        <meta property="og:url" content={`${getDev8xPublicUrl()}/react-js`}></meta>
