      ...
      <FooterRevealPageWrap variant="frame">
        ...
        <FooterRevealPageWrap variant="page">
          ...
          <main className={`${styles['expertise-single']} container-full`}>
            <Hero tagText="Education" heading="Digital spaces where knowledge can thrive" image="https://a-us.storyblok.com/f/1017006/3810x2036/6fe5a4bbe5/sussex-3810-x-2039.jpg" />
            <div>
              <ModularBlocks>
                <IconCards title="Extraordinary education experiences" paragraph="From early learning to university, we work across the full education spectrum to drive enrolments, increase awareness and offer outstanding student experiences." IconCardsItems={PageData.IconCardsItems} />
