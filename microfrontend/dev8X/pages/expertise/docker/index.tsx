...
import PageData from '../../../data/expertise/docker/index.d';
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href={`${getDev8xPublicUrl()}/docker`} />
        ...
        <meta property="og:url" content={`${getDev8xPublicUrl()}/docker`}></meta>
