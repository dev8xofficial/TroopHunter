...
import PageData from '../../../data/expertise/backend/index.d';
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href={`${getDev8xPublicUrl()}/backend`} />
        ...
        <meta property="og:url" content={`${getDev8xPublicUrl()}/backend`}></meta>
      ...
      <FooterRevealPageWrap variant="frame">
        ...
        <FooterRevealPageWrap variant="page">
          <main className={`${styles['expertise-single']} container-full`}>
            <Hero variant="blue" tagText="Backend" heading="Building powerful, scalable backends" image="https://a-us.storyblok.com/f/1017006/3810x2036/6fe5a4bbe5/sussex-3810-x-2039.jpg" />
