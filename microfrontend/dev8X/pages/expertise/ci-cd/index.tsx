...
import PageData from '../../../data/expertise/ci-cd/index.d';
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href={`${getDev8xPublicUrl()}/ci-cd`} />
        ...
        <meta property="og:url" content={`${getDev8xPublicUrl()}/ci-cd`}></meta>
      ...
      <FooterRevealPageWrap variant="frame">
        ...
        <FooterRevealPageWrap variant="page">
          <main className={`${styles['expertise-single']} container-full`}>
            <Hero variant="blue" tagText="CI/CD" heading="Streamlined delivery with continuous integration and deployment" icon={<InfinityIcon width="120" />} />
