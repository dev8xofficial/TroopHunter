...
const Footer: React.FC = (): JSX.Element => {
  return (
    <>
      <footer className="z-0 col-start-1 col-end-auto row-start-2 row-end-auto max-h-[100svh] transform bg-[#ffffff] text-[var(--theme-secondary)] transition-[color_.4s] dark:bg-charcoal-300">
