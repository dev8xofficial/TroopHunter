      ...
      <FooterRevealPageWrap variant="frame">
        ...
        <FooterRevealPageWrap variant="page">
          ...
          <main className={`${styles['expertise-single']} container-full`}>
            <Hero tagText="Payload CMS" heading="The next generation headless CMS" image="https://a-us.storyblok.com/f/1017006/3810x2036/6fe5a4bbe5/sussex-3810-x-2039.jpg" />
            <div>
              <ModularBlocks>
                <IconCards title="A CMS built for the future" paragraph="Optimised for the modern web, Payload is the fastest growing open-source headless CMS and provides an advanced, scalable approach to content management." IconCardsItems={PageData.IconCardsItems} />
