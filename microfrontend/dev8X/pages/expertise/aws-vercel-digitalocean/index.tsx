...
import PageData from '../../../data/expertise/aws-vercel-digitalocean/index.d';
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href={`${getDev8xPublicUrl()}/aws-vercel-digitalocean`} />
        ...
        <meta property="og:url" content={`${getDev8xPublicUrl()}/aws-vercel-digitalocean`}></meta>
