      ...
      <FooterRevealPageWrap variant="frame">
        ...
        <FooterRevealPageWrap variant="page">
          ...
          <main className={`${styles['expertise-single']} container-full`}>
            <Hero tagText="Headless" heading="Faster, better, stronger: Headless web development" image="https://a-us.storyblok.com/f/1017006/3810x2036/6fe5a4bbe5/sussex-3810-x-2039.jpg" />
            <div>
              <ModularBlocks>
                <IconCards title="Scale, security & performance, built-in" paragraph="Take advantage of headless to optimise your website and offer visitors an unparalleled experience." IconCardsItems={PageData.IconCardsItems} />
