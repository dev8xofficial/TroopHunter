...
const Contact: React.FC = (): JSX.Element => {
  ...
  return (
    <>
      ...
      <main className="relative h-full max-h-screen min-h-screen font-medium leading-relaxed transition-colors duration-500 ease-in-out bg-[#ebf8ff]" id="smooth-scrollbar">
        <Header />
        <section id="hero-section">
          <Hero tagBgColor="#82d7ff" tagText="Mobile Apps" heading={['We', 'design,', 'build', 'andship', 'awesome', 'mobile', 'apps']} image=" https://a-us.storyblok.com/f/1017006/2998x1590/a83f9d0b22/martialytics_placeholder.png" />
        </section>
