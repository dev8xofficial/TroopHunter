    ...
    },
    {
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M3 17.63H3.35999C3.93999 17.63 4.50999 17.48 5.01999 17.19C5.52999 16.9 5.95 16.49 6.25 15.99L10.98 8.01001C11.28 7.51001 11.7 7.1 12.21 6.81C12.72 6.52 13.29 6.37 13.87 6.37H20.93" stroke="var(--theme-primary)" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round"></path> <path d="M17.6099 14.25L20.9799 17.62L17.6099 20.99" stroke="var(--theme-secondary)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
