  ...
  IconCardsItems: [
    {
      ...
      icon: (
        <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ '--width': 28, '--height': 28 } as CSSProperties}>
          <path d="M9.46167 10.1617L9.89334 6.60334C10.1267 4.67834 11.9467 3.30166 13.965 3.52333C15.9833 3.74499 17.43 5.48333 17.1967 7.40833L16.835 10.43" stroke="var(--theme-primary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M19.7399 8.75L18.7132 24.5L5.03991 23.0883C4.40991 23.0183 3.97824 22.435 4.11824 21.8167L6.98824 8.75H19.7399V8.75Z" stroke="var(--theme-secondary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>{' '}
          <path d="M23.45 21.2917L18.7017 24.5L19.7283 8.75L22.9017 9.765L23.905 20.3233C23.94 20.7083 23.765 21.07 23.45 21.2917Z" stroke="var(--theme-secondary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>{' '}
        </svg>
      )
    },
    {
    ...
    },
    {
      ...
      icon: (
        <svg width="27" height="24" viewBox="0 0 27 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ '--width': 27, '--height': 24 } as CSSProperties}>
          <path d="M10.3731 9.4001C12.7894 9.4001 14.7482 7.51968 14.7482 5.20005C14.7482 2.88043 12.7894 1 10.3731 1C7.95683 1 5.99805 2.88043 5.99805 5.20005C5.99805 7.51968 7.95683 9.4001 10.3731 9.4001Z" stroke="var(--theme-secondary)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M18.8789 1.59998C20.1494 2.33492 20.9992 3.67221 20.9992 5.20002C20.9992 6.72783 20.1494 8.06512 18.8789 8.80006" stroke="var(--theme-primary)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>{' '}
          <path d="M11.3501 14.2002H9.40011C9.02861 14.2002 8.84286 14.2002 8.68584 14.2064C4.51427 14.3703 1.17012 17.7145 1.00617 21.886C1 22.0431 1 22.2288 1 22.6003H19.7502C19.7502 22.2288 19.7502 22.0431 19.7441 21.886C19.5801 17.7145 16.236 14.3703 12.0644 14.2064C11.9074 14.2002 11.7216 14.2002 11.3501 14.2002Z" stroke="var(--theme-secondary)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>{' '}
          <path d="M25.9996 22.6002V21.8802C25.9996 19.1919 25.9996 17.8478 25.4546 16.821C24.9753 15.9178 24.2104 15.1835 23.2695 14.7233" stroke="var(--theme-primary)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>{' '}
        </svg>
      )
    }
  ],
