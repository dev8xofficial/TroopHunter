...
import PageData from '../../../data/expertise/ecommerce/index.d';
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href={`${getDev8xPublicUrl()}/ecommerce`} />
        ...
        <meta property="og:url" content={`${getDev8xPublicUrl()}/ecommerce`}></meta>
