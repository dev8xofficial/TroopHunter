...
import PageData from '../../../data/expertise/postgresql/index.d';
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href={`${getDev8xPublicUrl()}/postgresql`} />
        ...
        <meta property="og:url" content={`${getDev8xPublicUrl()}/postgresql`}></meta>
