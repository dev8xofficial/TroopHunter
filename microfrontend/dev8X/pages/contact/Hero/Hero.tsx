          ...
          <form className="grid-template-columns-repeat-2-auto-1fr text-[clamp(1rem,1.0582010582vw,1.33rem)] gap-[clamp(3.125rem,3.3068783069vw,4.15625rem)_clamp(1.25rem,1.3227513228vw,1.6625rem)] items-start grid">
            ...
            <div className="col-span-full grid items-start">
              ...
              <div className="relative">
                <input
                  id="referral"
                  className="rounded-none appearance-none text-[rgba(18,3,42,.7) border-b-[1px] py-[1em] px-0 w-full duration-300 focus:border-[#b488f1] focus:outline-none  "
                  type="text"
                  name="referral"
            ...
            <div className="col-span-full grid">
              <button className="bg-none appearance-none p-0 border-none text-inherit bg-inherit no-underline inline-block">
                <span className="relative cursor-pointer rounded-full text-white bg-[#b488f1] font-bold gap-[.5em] flex px-[1.1em] py-[1.1em] text-[clamp(.9375rem,.9920634921vw,1.246875rem)] justify-center text-center">
                  Submit
                </span>
              </button>
            </div>
