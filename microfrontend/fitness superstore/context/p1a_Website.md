...
- Weight: 370 lbs
- Dimensions: 81" L x 28.5" W (at base; 38" at upper hand grips) X 60" H
...
My favorite elliptical. Simple. No bells and whistles but incredibly effective for fitness training. Especially effective for leg strengthening and heart rate fitness training.

Love the Arc Trainer

Being a big guy... I have often said that I am an athlete trapped inside a fat man's body... and the Arc Trainer has certainly helped me stay more fit over the years. it's easy on the knees and provides a great work out.

Cybex 610 Arc Trainer (remanufactured)
...
Engineered to replace multiple standalone stations, the FSR100 combines a Smith machine, squat rack, functional trainer, pull-up station, landmine, and optional leg press, jammer arms, and lat pulldown/low row into one powerhouse.

It’s constructed with 11-gauge reinforced steel and uses industrial aircraft-rated cables with a 2,000-pound tensile strength. The Smith bar runs on ball-bearing guide rods, which helps keep motion controlled and predictable during your lifts. The build and component choices are intended to support consistent use in both commercial spaces and home gyms.

Whether you’re equipping a training studio or expanding your personal gym, the FSR100 offers a flexible foundation you can continue to build on over time.
...
- Two 220 lb weight stacks with a 2:1 pulley ratio
- Multiple training stations in one machine
- Landmine attachment with full swivel
- Pull-up bar with a 551 lb capacity
- Seated row footrest
- Integrated Olympic bar holders
- Large selection of included handles and bars
...
- Cable system allows smooth resistance adjustments across many exercises
- Built to handle consistent use in commercial or home gym settings
...
- Size of Ea. Cable Column Hole: 0.658"
- Maximum user weight: 350 lbs (159 kg)
- Maximum user weight (Lat Pulldown Knee Cushion): 350 lbs (159 kg)
- Maximum Capacity (Pull Up Bar): 551 lbs (250 kg)
- Max Load (J Hooks): 992 lbs (450 kg)
- Max Load (Spotter Arms): 1102 lbs (500 kg)
- Max Load (Smith Bar): 992 lbs (450 kg)
- Max Load (Seated Foot Rest): 661 lbs (300 kg)
- Max Load (Plate Storage): 135 lbs (61.2 kg) each (6 weight horns)| 810 lbs (367.41) combined
- Smith Bar Weight: 46 lbs (20.5 kg)
- Smith Bearing Type: Ball Bearings
- Weight: 1113.3 lbs (505 kg)
- Inner Frame Width: 42.52" (115.6 cm)
- Height to Top Pulley: 90.8" (41.2 cm)
- Height to Top Metal Frame Post: 89.4" (227.1 cm)
- Height (Top of Pull Up Bar): 87.4" (222 cm)
- Dimensions: 62.5" L x 75" W x 91.2" H (1589 cm x 190.5 cm x 231.8 cm)
- Footprint (Part That Touches Floor) Before Power Band Holders are Attached: 48" L x 49.5" W (121.9 cm x 25.7 cm)
- Total Depth with FSR100 Lat Pulldown / Low Row Attachment Added: 84" (213.3 cm)
...
1. Versatility and Training Variety
Look for a setup that brings multiple stations together so you can train efficiently in one area. The FSR100 includes a functional trainer, Smith machine, squat rack, landmine, and optional attachments, giving you a broad range of exercise options within a single unit.

2. Strength and Load Capacity
Check the load ratings for both the Smith bar and the safety supports. The FSR100 Smith bar is rated for 992 lbs, and the spotter arms are rated for 1102 lbs. These capacities help support heavier training sessions when needed.

3. Upgradeability and Customization
Some machines come with fixed configurations, while others offer room to expand. The FSR100 supports weight stack upgrades and modular add-ons such as jammer arms, a leg press attachment, dip handles, and more, allowing you to adapt the machine to future training needs.

4. Build Quality and Durability
Consider the frame construction, cable strength, and overall component quality. The FSR100 uses 11-gauge steel and aircraft-grade cables with a 2,000 lb tensile strength. These materials are commonly used in commercial environments where equipment sees frequent use.

5. Space Considerations
If space is limited, a multi-station configuration can be helpful. The FSR100 brings several training functions into one footprint, which can make planning your gym layout simpler.

6. Who It’s Designed For

- Commercial Gyms: Built to handle regular use from multiple lifters throughout the day.
- Home Gym Owners: Offers many training stations in one place, reducing the need for separate machines.
...
It comes with two 220 lb stacks (440 lbs total) using a 2:1 pulley ratio, which makes each side feel like 110 lbs. Heavier stacks are available as an upgrade during purchase.

Yes. The combination of the Smith machine, squat rack, functional trainer, landmine, pull-up station, and optional attachments allows for full-body programming.

Life Fitness and Hammer Strength manufacture commercial training systems with their own designs and feature sets. The FSR100 is another option within the broader multi-station category and provides a range of functions in one consolidated unit.
...
This treadmill is great. We had never found one for the house that we liked, but always love the ones at the Marriott hotels. So I broke down and bought one. It was worth the money.
...
Built with 11-gauge ASTM A36 steel and finished in a durable electrostatic powder coat, this unit is engineered for high-traffic facilities. The system includes a dual pulley lat pulldown, dual pulley low row, adjustable crossover station, and fixed tricep extension. With independent weight stacks ranging from 220 lbs to 264 lbs, users can train simultaneously without sacrificing resistance or smooth operation.

The adjustable pulleys feature 20 vertical height positions and 180-degree swivel capability, expanding exercise options for functional training, rehabilitation, strength development, and sport-specific movements. Nylon-coated military-spec cables and sealed bearing pulleys ensure consistent performance and long-term durability. Solid steel weight plates with self-lubricating bushings maintain smooth travel during every repetition.

Designed to improve space efficiency and training flow, this 4 Stack Multi Jungle Gym allows gyms and performance centers to increase member capacity without expanding floor space. With a maximum user weight of 350 lbs and a total machine weight of 1,585 lbs, it offers the stability required for demanding environments.
...
- Nylon-coated cable meets U.S. military specifications
...
- Paint Color: Black
- Vinyl Color: Black
- Cable Reach (Adjustable Pulley): 98"
- Cable Reach (Tricep, Lat, & Row Stations): 49"
- Max User Weight: 350 lbs (158 kg)
- Product Weight: 1585 lb (719 kg)
- Dimensions: 143"L x 92"W x 94.25"H
- Pulleys Swivel 180 Degrees
- Number of Vertical Adjustments: 20
...
Built with reinforced steel uprights and smooth linear bearing Smith bar movement, the French Fitness FSR90 Functional Trainer allows seamless transitions between guided Smith lifts, free weight barbell training, and cable based exercises. Dual 220 lb weight stacks provide balanced resistance for rows, presses, flies, and rotational movements, while the 2:1 ratio keeps adjustments precise and manageable for all experience levels.

The integrated squat rack includes adjustable J hooks and safety catches, allowing confident barbell training without a spotter. Jammer arms, landmine attachment, pull up bar, dip handles, and lat pulldown capability expand training options far beyond a standard rack. This makes the French Fitness FSR90 Functional Trainer ideal for users who want to replace multiple machines with one space efficient solution.

Designed for durability, this system supports heavy loads across all stations, including a 600 lb Smith capacity and a 500 lb rated pull up bar. Whether your goal is strength progression, functional conditioning, or total body training, this machine delivers commercial level performance in a compact footprint.
...
- Adjustable/Removable Dip Handles
- Multi-Grip Pull-Up Bar with knurled grips (500 lb rating)
- Quick-adjust J-hooks & safety catches; chrome/stainless wear points
- Built-in storage – Olympic plate pegs + vertical Olympic bar holder
- Thick steel barbell hooks with quick and easy height adjustment
- Chrome/stainless steel used for most contact points (more scratches-resistant)
- Thick steel barbell safety hooks with quick and easy height adjustment
- Quick and easy pop pin functional adjustment
...
- Safety First: Smith machine and adjustable safeties reduce risk when lifting heavy alone.
...
- Width (Outer Part of Cage): 52" (132 cm)
- Dimensions w/ Jammer Arms Fully Extended: 101.5" (Jammer Arms extend 56.5" from Cable Columns)
- Recommended Footprint: ~ 9 ft wide × 11 ft long for safe movement and accessory clearance
- Product Weight: 992 lb (450 kg)
- Frame Thickness: 2" × 2.75" uprights • Cable Columns: 2" × 2"
- Smith Bar: 88 1/8" Olympic, 45 lb, linear ball bearings (not counterbalanced); straight vertical travel
- Bushing Type: Weights have Plastic / Nylon Bushings. Bronze bushings for the rest of the machine
- Max Loads: Smith 600 lb • J-Hooks 550 lb • Safety Catches 660 lb • Pull-Up Bar 500 lb • Plate Storage 600 lb
...
- 2:1 Ratio
- Weight Stack Increments: (20) 11 lbs weight plates per side (feels like 5.5 lb per click)
- Cable Specs: 4.8 mm PA; Tensile 2160 MPa; Breaking Load 2,293 lb; Elongation 80–88%
- Cable Travel: 62"
- Selector Pin: 10 mm
...
- Ultra smooth smith machine movement and solid steel tubing
- Adjustable safety catches for Smith Machine exercises
- 88 1/8" Olympic Smith Bar (Weighs 45 lbs)
- Distance from the bottom of the smith bar to the floor when the smith bar is touching the top bumpers: 74"
- Distance from the bottom of the smith bar to the floor when the smith bar is resting on the top hook: 66.77" (170 cm)
...
- Pins (7) & Carabiners (4) – Fast swaps across stations
- Extension Chains (Set) – Increase cable reach/range for tall or floor moves
- Spring Collars (6) + Jaw Lock Collars (Set) – Secure plates on Smith/landmine bars
- Safety Bar Catches (Set) – 16" extension from columns for confident fails (Included in the Depth measurement of 65")
- Dual Adjustable Dip Bars – Removable; multiple heights for chest/tri focus
- Lat Pull Knee Cushion w/ Right J-Hook – Locks in for stable pulldowns
- Left & Right J-Hooks – 4.5" extension; quick height indexing (Extends 4.5" From Cable Columns)
- Landmine Attachment – T-bar rows, presses, anti-rotation core
- Straight Bar & Lat Bar – Bilateral push/pull cable staples
- Dual Hook Revolving Straight Bar – Smooth triceps/biceps cable work
- Dual Hook Jammer Arm Connector – Converts jammer arms for leg press patterns
- Vertical Leg Press Plate (17 lb) – Smith-based leg press setup
- Platform (#18) – Leverage squats, calf raises, push/press with jammer arms
...
It’s a great choice for home gym owners, personal training studios, and athletes who want a durable, multi-functional piece of equipment.

2. Can it handle barbell training?

Yes. The squat rack includes adjustable J-hooks and safety spotter arms, so you can train with free weights just as you would on a stand-alone rack.

3. Is it beginner-friendly?

Absolutely. The Smith bar provides a controlled path for learning major lifts, while the cables allow lighter, more gradual resistance.

4. Does it replace a full gym?

The FSR90 delivers nearly everything you’d expect from a complete training facility. By combining free-weight lifts, Smith machine exercises, and a full range of cable movements, it gives you the functionality of multiple machines in one space-saving design.

Upgrade your training with the French Fitness FSR90 Functional Trainer, Smith Machine & Squat Rack. Whether you’re building a home gym or enhancing your training facility, this all-in-one system delivers the performance, safety, and versatility you need to push past limits.
...
The best products and the best company you will ever find is here, French Fitness!

I spent about four weeks researching all the different functional trainers with the integrated Smith bar. I wanted something that would do everything possible but also something that was beautiful. I have a beautiful home and didn’t want my new home gym to look exactly like some of the gyms I belong to and have gone to in my life. When I work out at home, I want the equipment to be perfect and look fantastic and still work better than it looks. Well, after lots of research and talking to companies, French Fitness was the winner in every possible area. I ordered the FSR 90 in black and yellow. It had all the accessories that I needed for the machine, one of the items I wanted to make sure it included was the leg press plate and the jammer arms. This one came with a whole lot more. All parts are simple to put on, change or remove, the machine is smooth as silk in every way no matter how much weight you have on the machine or you’re using. Whether it’s a Smith bar or the pully System with the weight stack in which I did upgrade to the highest weight. I paid for installation and was very glad I did. I am very technical, and put anything together, but I sure did not feel like caring almost 1900 pounds upstairs and then putting it together myself. Of course that includes Olympic plate sets and other stuff that I purchased for the unit.

More

Amazing equipment

Very well packed. This machine is the best piece of equipment I have ever bought. You can literally work multiple variations of every muscle group. They have thought of everything. The accessories that come with the machine store within the machine frame and are so easy to move from one exercise to another. I would highly recommend this machine to anyone.

Home Workout !

So far it is a great fit for our home gym. We like the versatility. storing some of the accessories is a bit of challenge. So far the accessories seem to be well made.
Paying to have it assemble was a good move.

Great for a home gym

I love the machine. It has everything you need for a full body workout. Very versatile and well made.
...
- Product Weight: 425 lbs (192.7 kg)
- Height: 72" (183cm)
- Length: 64.5" (164cm)
- Width: 41" (104cm)
...
- Arms: Moving
- Stride: Advance Stride and Same Side Forward Technology
- Incline Levels: 11
- Resistance Levels: 20
- Wireless Heart Rate Telemetry
...
- Same Side Forward (SSF) Orientation
- Intuitive Split-Level Display
- Wireless Heart Rate Monitoring
- Incline Levels: 11
- Stride Length: 24 inches
- Resistance Range: Up to 450 watts
...
- Resistance Levels: 20
- Stepping Speed Rate: 26-174 steps/minute
- Reading Rack
...
I owned a 4200pt for twenty years and finally wore it out. I have been without it for a year now and miss it. I originally bought the 4200 because it had a max user weight of 350lbs. That being said with the help of diet and 4200 I’m down to 240 from 325.
...
For Residential Use - In-Home Warranty (This Warranty Applies if Machine is in a Residential Setting)
...
Great product delivered in super fast time!
...
With adjustable back and seat pads, users can customize workouts to target different muscle groups. From bench presses to shoulder presses, the SFI20 is perfect for various exercises.

The Body-Solid Pro Clubline SFI20 Bench is both comfortable and convenient. Its thick, padded seat and back pads provide comfort during workouts. Plus, the built-in handle and wheels make moving around a gym or facility easy.
...
- Suitable for various exercises: inclines, presses, curls, rows, dips, and more
...
-French Fitness Napa Selectorized Horizontal Calf
...
Offered as option with French Fitness Urethane 8 Sided Hex Dumbbell 5-50 lbs Set and 5-60 lbs Set
...
- Thickness: 3/4" (19 mm)
- Volume Density: Approx. 1,000 kg/m3
...
- Display Readout: Fat Burner, Fat Burner Plus, Steady Pace, Rolling hills, Aerobic Training, Cross Country, Speed Training, Fit Test, Levels
- Fitness Tests: Multi-stage Fit Test and CPAT Fire Fit Test
- Step Range: 1 to 14 inches
...
- Paint Color: Black
- Vinyl Color: Black
- Distance from top edge of footplate to pad: 28.13" to 38.76" (714.5mm to 984.5mm)
- Number of Pad Distance Adjustments: 10
...
Arrived quickly and in good shape. Good customer service. A good, simple & compact hyperextension.
...
This plate loaded design allows users to progressively increase resistance while maintaining proper form. The fixed arm path supports a natural curling motion that enhances peak contraction and promotes balanced muscle development. By stabilizing the upper body, the machine ensures that the biceps remain the primary driver throughout every repetition.

Constructed from 11 gauge flat oval steel tubing, the frame is reinforced for commercial grade durability. A dual layer anti static powder coat finish enhances adhesion and protects against wear in high traffic environments. Molded foam cushions provide firm yet comfortable support, maintaining alignment while reducing pressure during heavy sets. Urethane composite hand grips are secured with aluminum collars to prevent slipping, ensuring a confident hold under load.

With a user height range accommodating most athletes and a solid 274 pound frame weight for stability, the Biceps Arm Curl Plate Loaded machine is built to handle serious training. Whether placed in a commercial facility or advanced home gym, it delivers focused arm development, smooth operation, and long term reliability for consistent strength gains.
...
- Vinyl Color: Black
- 11 Gauge Steel
- Tube Material: Flat Oval Steel Tube
...
- Thick, durable padding
- Sealed bearing and independent back & seat adjustments
- Back pad adjusts flat, incline (15, 30, 45, 60 and 80 degrees) and decline (-18 degrees)
- Seat pad adjusts flat, 10, and 18 degrees
- Leg hold down to perform decline presses, sit-ups and more
...
- Armless
- Exercise Programs: Quick Start, Manual, Fat Burner, Calorie Burner, Speed Intervals, and Heart Rate Zone
- Display Readout: Manual, Fat Burner, Fat Burner Plus, Steady Pace, Rolling Hills, Aerobic Training, Cross Country, Speed Training, Fit Test, Levels
- Fitness Tests: Multi-stage Fit Test and CPAT Fire Fit Test
- Step Range: 1 to 14 inches
- Step Rate: 26 to 174 steps/minute
- Resistance Levels: 20
...
The Body-Solid SGH500 Glute Ham Machine is an essential piece of equipment for any fitness facility. Constructed with high-quality commercial-grade components, the SGH500 ensures durability and reliability, even in gyms that experience heavy usage and high traffic.

The Body-Solid Glute Ham Machine effectively isolates and strengthens various muscles, including the lower back, abs, obliques, calves, glutes, and hamstrings. It offers a variety of movements, such as glute ham raises, hip extensions, back extensions, reverse hyperextensions, Sorenson holds, and GHD sit-ups. Band pegs on the bottom of the SGH500 easily allow users to add resistance bands or tubes for even more effective workouts.

Users can expect exceptional comfort and support during their exercises thanks to the machine's thick, double-stitched DuraFirm 7.5" knee & shin pads and oversized foam rollers.
...
- Heart Rate Monitoring: Pulse Grip & Wireless Strap w/ heart control
- Personal Cooling Fan: No
- Motor: Incline Motor
- Equipped with two water bottle holders, a CD player holder, a key holder and cell phone compartment.
- SafetySentry knows whether you are there or not, which helps to keep children and pets safe. The belt stops after the waiting period you preselect.

Console Features

- Display: LED
- Display: Distance, Calories, METs, Pace, Heart Rate, Time, Elevation
...
- Color Coded Pivot Points And Adjustments: Yes on all units
- Unilateral or Bilateral Movement: Yes, unit dependent
...
- Frame Finish: Electrostatic Powder coating
- Customizable Paint Options Available: Yes with additional fees and extended lead times
- Customizable Upholstery Options Available: Yes with additional fees and extended lead times
- Customizable Branding Options Available: Yes with additional fees and extended lead times
- Cable vs. Belt Driven Transmission: SKU dependent
- Bolt Down Locations Defined: Yes
- Integrated Leveling System: No, rubber feet for floor protection
- Hardware Type: Hex / Button Head
...
- Animated Lenticular: No
- Safety Catch & Stops: Yes, SKU dependent
- Water Bottle Holder: No
- Phone Holder: No
- Grip Specifications: Rubber, large grips for pushing, smaller grips for pulling.
- Foot Platform: Machine dependent
...
- Incremental Weight System: 5 lb incremental weight system for optimal progression* except for Chin Dip Assist
- Weight Stack Tower Height: Machine dependent
- Plate Loaded: N/A
- Weight Storage Solution: N/A
- LNL Technology: Yes
...
- Fitness Tests: Multi-stage Fit Test and CPAT Fire Fit Test
- Easy-Grip Upper-Body Handles
- Ergonomically Designed Side Handrails
- Heart Rate Monitoring: Contact and Wireless Compatible
- Reading Rack, Built-In Cassette and Water Bottle Holders
- Resistance Levels: 20
- Step Range: 1" to 14"
- Step Rate: 26 to 174 steps/minute.
...
- Steel tube material is used to ensure durability
- An electrostatic powder coat finish is applied to every frame to ensure maximum adhesion and durability
- The molded foam used in contoured cushions provides exceptional comfort
- Bolt-together design
- 19-inch anti-slip foot plate
...
Solid machine for a great price
...
- Display Readout: Time, Calories, Manual, Fat Burner, Aerobic Training, Speed Intervals, Constant Heart Rate
- Fitness Tests: Multi-stage Fit Test and CPAT Fire Fit Test
- Soft Pedals For Ultimate Comfort and Low Impact
- Easy-Grip Upper-Body Handles
- Ergonomically Designed Side Handrails
- Heart Rate Monitoring: Contact and Wireless Compatible
- Reading Rack, Built-In Cassette and Water Bottle Holders
...
Independent iso lateral arms allow each side to move on its own, helping correct muscle imbalances and improve symmetry. In the starting position, the handles are wide and converge naturally as you press forward, following the body’s natural arc. This converging motion enhances peak contraction while reducing unnecessary strain on the shoulder joints.

A spring assist adjustable seat accommodates a wide range of user heights, ensuring proper alignment for safe and effective pressing mechanics. Contoured molded foam cushions provide firm support during heavy lifts, while urethane composite grips secured with aluminum collars prevent slipping under load. Six standard weight horns keep plates organized and within reach, minimizing downtime between sets.

Constructed from 11 gauge steel with flat oval tubing and finished with a durable electrostatic powder coat, this unit is built to withstand consistent commercial use. With a starting resistance of 6 pounds per work arm and generous plate capacity, the Decline Chest Press Plate Loaded machine supports progressive overload for beginners and advanced lifters seeking reliable strength gains and long term durability.
...
- Vinyl Color: Black
- 11 Gauge Steel
- Tube: 50 x 100 x 3.0mm
- Flat oval steel tube
- Iso-Lateral Arms: Each arm moves independently.
- Chest Press Station: Converging Arms. In the starting position, the handles are wide. As the user presses, the motion converges towards the middle.
- Each frame receives an electrostatic powder coat finish to ensure maximum adhesion and durability
- Standard rubber feet protect base of the frame and prevent the machine from slipping
- Contoured cushions utilize a molded foam for superior comfort and durability
- Hand Grips retained with aluminum collars, preventing them from slipping during use
- Hand grips are a durable urethane composite
...
- Starting Resistance: 6 lbs (3 kg) per work arm
- Max User Weight: 350 lbs (158 kg)
- Product Weight: 271 lbs (123 kg)
- Height 77.75"w/o placard... 78.75" w/placard
- Width: 72"
- Depth: 57"
- User Height Range: 4'11" to 6'5" (149.86 cm to 195.58 cm)
...
Hexagonal Design Prevents dumbbell from rolling and allow for easy stacking and convenient storage.

Great for All Types of Workouts Perfect for a variety of individual and group workouts, including jogging and power walking, aerobics, general exercise, physical therapy and even yoga routines.
...
- Ergonomically Designed Side Handrails
- Heart Rate Monitoring: Contact and Wireless Compatible
- Reading Rack, Built-In Music and Water Bottle Holders
- Resistance Levels: 20
- Step Range: 1" to 14"
- Step Rate: 26 to 174 steps/minute
...
- Ergonomically Side Handrails
- Contact Heart Rate Monitor
- Resistance Levels: 20
- Step Range: 1" to 14" / 2.5 to 36 cm
- Step Rate: 26 to 174 steps/minute
- Heart Rate Monitoring: Contact Heart Rate Monitor & Polar-compatible wireless Computer
- Display Type: Original Console
...
The handles move outward as they travel downward, creating a natural pulling arc that supports a fuller stretch at the top and a stronger contraction at the bottom of each repetition. This motion distributes load more evenly across the back while reducing unnecessary stress on the spine and shoulder joints. Iso-lateral movement ensures both sides develop evenly, preventing one arm from compensating for the other.

Slightly angled seat and chest pads stabilize the body during heavy pulls, encouraging strict form and consistent engagement of the lats, rhomboids, and rear delts. Molded foam cushions provide firm support, while urethane composite grips secured with aluminum collars prevent slipping under load. Rubber feet add stability and protect flooring in commercial environments.
...
- Each frame receives an electrostatic powder coat finish to ensure maximum adhesion and durability
- Standard rubber feet protect the base of the frame and prevent the machine from slipping
- Contoured cushions utilize a molded foam for superior comfort and durability
- Grips retained with aluminum collars, preventing them from slipping during use
- Hand grips are a durable urethane composite
...
- User Height Range: 4'11" to 6'5" (149.86 cm to 195.58 cm)
- Max User Weight: 350 lbs (158 kg)
- Product Weight: 323 lb (147 kg)
- Dimensions (Stationary): 52" L x 59.5" W x 74.5" H (132.1 cm x 151.1 cm x 189.2 cm)
...
- Display: Graphic display of workout profile via 8 x 5 LED; Numeric display of time, calories, revolutions per minute, calories per hour and heart rate including multi-color indication of heart rate range; Lower display shows road speed and resistance level
- Connectivity: Optional: Made for iPod®, Works with iPhone® iPod/iPhone integration with 30-pin connector. Users can easily charge an iPod or iPhone, listen to music, switch tracks, and control volume.
...
- Convenience features: Tablet / magazine rack, dual water bottle holders and utility tray
...
Each arm operates independently, preventing one side from compensating for the other. In the starting position, the handles are closer together and naturally separate as you pull toward the torso. This diverging motion follows a powerful anatomical arc that promotes deeper contraction and improved scapular retraction. The result is stronger mid back engagement and better posture carryover into other compound lifts.

Four easily accessible weight horns allow quick plate changes between sets, improving workout efficiency in busy training environments. Molded foam cushions provide firm chest and seat support, helping maintain strict form under heavy loads. Urethane composite grips secured with aluminum collars prevent slipping, ensuring confident pulling during high intensity sessions.
...
- 50 mm x 100 mm x 3 mm Flat oval steel tube
- Iso-Lateral Arms: Each arm moves independently.
- Back Station: Dispersing / Separating Arms. In the starting position, the handles are close. As the user pulls, the motion separates as the handles get closer to the chest.
- Each frame receives an electrostatic powder coat finish to ensure maximum adhesion and durability
- Standard rubber feet protect base of the frame and prevent the machine from slipping
- Contoured cushions utilize a molded foam for superior comfort and durability
- Grips retained with aluminum collars, preventing them from slipping during use
...
The design supports true single leg training. One knee rests securely on the adjustable swinging knee pad while the opposite leg performs the curl. The knee pad shifts easily from side to side, making transitions smooth and efficient. This setup keeps tension directly on the hamstrings while minimizing lower back involvement.

Comfortable forearm pads and ergonomic handles stabilize the upper body, ensuring strict form and controlled movement throughout each repetition. By securing the torso, the machine allows users to apply maximum effort to the working leg without unnecessary body movement or momentum.

Constructed from 11 gauge flat oval steel tubing and reinforced with an electrostatic powder coat finish, this unit is built for demanding commercial environments. With a solid 311 pound frame weight and a maximum user capacity of 350 pounds, the Kneeling Leg Curl Plate Loaded Iso-Lateral machine delivers durable performance, smooth operation, and the isolated hamstring strength development serious athletes expect.
...
The Body-Solid SGH500B Glute Ham Machine is an essential piece of equipment for any fitness facility. Constructed with high-quality commercial-grade components, the SGH500B ensures durability and reliability, even in gyms that experience heavy usage and high traffic.

The Body-Solid Glute Ham Machine effectively isolates and strengthens various muscles, including the lower back, abs, obliques, calves, glutes, and hamstrings. It offers a variety of movements, such as glute ham raises, hip extensions, back extensions, reverse hyperextensions, Sorenson holds, and GHD sit-ups. Band pegs on the bottom of the SGH500B easily allow users to add resistance bands or tubes for even more effective workouts.
...
Great for All Types of Workouts Perfect for a variety of individual and group workouts, including jogging and power walking, aerobics, general exercise, physical theraphy and even yoga routines.
