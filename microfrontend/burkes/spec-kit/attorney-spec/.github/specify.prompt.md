# Specify Prompt — The Burkes Group Agent Portal

## Purpose

Use this prompt to generate or update a feature specification for the Burkes Group Agent Portal. This prompt is pre-loaded with portal context so you do not need to re-explain the product to Copilot.
...
You are writing specifications for **The Burkes Group Agent Portal** — a single-page web portal used by real estate agents to manage client transactions, documents, communications, appointments, partner referrals, and performance analytics.
