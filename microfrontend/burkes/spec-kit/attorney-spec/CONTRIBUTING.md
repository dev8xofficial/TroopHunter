# Contributing to the Attorney Portal Spec-Kit
...
4. **Create a branch** — `spec/NNN-feature-name` (e.g., `spec/005-verification-update`)
...
|------|-----------|---------|
| Branch | `spec/NNN-feature-name` | `spec/005-verification-update` |
| Feature ID | `NNN-kebab-case` | `005-verification` |
| Requirement ID | `FR-NN-NN` | `FR-05-03` |
| Commit message | `spec(NNN): description` | `spec(005): add flag discrepancy requirement` |
