# Contributing to the Service Partner Portal Spec-Kit
...
| Feature ID | `NNN-kebab-case` | `006-service-areas` |
| Requirement ID | `FR-NN-NN` | `FR-06-03` |
| Commit message | `spec(NNN): description` | `spec(001): add referral cards requirement` |
