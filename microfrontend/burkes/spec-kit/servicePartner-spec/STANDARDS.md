# Writing Standards — Service Partner Portal Spec-Kit
...
- **Active voice**: "The partner uploads a document" not "A document is uploaded by the partner."
...
- Format: `NNN-kebab-case` (e.g., `000-foundation`, `006-service-areas`)
...
- First two digits = feature number (01 = Dashboard, 02 = Referrals, …)
...
|------|-------------|
| Service Partner | SP |
| Admin / Platform Administrator | AD |
...
- ADRs: `adr-NNN-kebab-case.md` (e.g., `adr-001-referral-centric-model.md`)
...
| Class | Usage |
|-------|-------|
| `new` | New Lead, unread referrals |
| `contacted` | Homeowner contacted, awaiting quote |
| `quoted` | Quote sent, awaiting acceptance |
| `scheduled` | Job scheduled, date confirmed |
| `completed` | Job finished, payment received |
| `declined` | Quote or referral declined |
| `processing` | Payment processing, awaiting clearance |
...
- [ ] All role references use canonical abbreviations (SP, AD, AG, CL)
