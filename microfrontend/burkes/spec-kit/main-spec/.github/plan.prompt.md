# Plan Prompt — The Burkes Group Agent Portal
...
You are planning implementation for **The Burkes Group Agent Portal** — a single-page web portal for real estate agents. The following shared infrastructure already exists and must be reused, not re-built:
