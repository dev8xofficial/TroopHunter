# Tasks Prompt — The Burkes Group Agent Portal
...
You are generating developer tasks for **The Burkes Group Agent Portal**. Tasks must be written for a frontend developer who is familiar with the portal's existing patterns but may not have deep context on the specific feature.
