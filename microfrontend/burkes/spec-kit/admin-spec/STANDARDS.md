# Writing Standards — Admin Portal Spec-Kit
...
- **Active voice**: "The agent uploads a document" not "A document is uploaded by the agent."
...
- Format: `NNN-kebab-case` (e.g., `000-foundation`, `007-partner-referrals`)
...
| Class | Usage |
|-------|-------|
| `active` | On Track, Closing Soon, Approved |
| `pending` | Delayed, Under Review, Needs Review |
| `completed` | Completed transactions and documents |
