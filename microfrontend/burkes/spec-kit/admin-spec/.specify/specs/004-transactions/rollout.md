...
This document defines how 004-transactions will be phased into production, from canary to full rollout. The goal is to detect issues early, minimize risk, and gather real-world feedback before full release.
...
```
🚨 **004-transactions Rollout Paused**
