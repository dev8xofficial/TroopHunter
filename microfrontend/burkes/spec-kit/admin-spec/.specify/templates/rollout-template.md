...
This document defines how [feature name] will be phased into production, from canary to full rollout. The goal is to detect issues early, minimize risk, and gather real-world feedback before full release.
...
| **Internal**      | +7 days      | 5%         | All employees (TC, agents using demo portal)      | Watch metrics; address non-critical issues                  |
