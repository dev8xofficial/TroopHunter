...
Implement the admin dashboard specification for the hr admin panel domain with contract-first validation, RBAC enforcement, and append-only audit coverage.
...
### Task 1: Model AdminDashboardSnapshot and FunnelMetric

**Complexity**: L
**Priority**: P0

**Description**: Finalize canonical data structures, validation rules, and ownership boundaries for admin dashboard.
...
**Description**: Implement the request and response contracts for GET /api/v1/admin/dashboard/summary, GET /api/v1/admin/dashboard/funnel, GET /api/v1/admin/dashboard/priority-queue.
...
### Task 4: Implement recruiting snapshot lifecycle
...
| interactions.yaml | Yes | Publishes Recruiting Snapshot Lifecycle transitions |
...
| --- | --- | --- |
| Phase 1 | 1-2 days | Model AdminDashboardSnapshot and FunnelMetric, Deliver core API surface, Enforce RBAC and data scoping |
| Phase 2 | 2-3 days | Implement recruiting snapshot lifecycle, Wire audit events, Add validation and regression coverage |
