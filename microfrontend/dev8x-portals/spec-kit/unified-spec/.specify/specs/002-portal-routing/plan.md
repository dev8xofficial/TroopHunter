# Portal Routing - Implementation Plan
...
Implement the portal routing specification for the authentication & identity domain with contract-first validation, RBAC enforcement, and append-only audit coverage.
...
### Task 1: Model PortalConfig and RouteDecision

**Complexity**: L
**Priority**: P0

**Description**: Finalize canonical data structures, validation rules, and ownership boundaries for portal routing.
...
**Description**: Implement the request and response contracts for GET /api/v1/portals/config, POST /api/v1/portals/resolve, GET /api/v1/portals/last-destination.
...
### Task 4: Implement portal resolution lifecycle
...
| interactions.yaml | Yes | Publishes Portal Resolution Lifecycle transitions |
...
| --- | --- | --- |
| Phase 1 | 1-2 days | Model PortalConfig and RouteDecision, Deliver core API surface, Enforce RBAC and data scoping |
| Phase 2 | 2-3 days | Implement portal resolution lifecycle, Wire audit events, Add validation and regression coverage |
