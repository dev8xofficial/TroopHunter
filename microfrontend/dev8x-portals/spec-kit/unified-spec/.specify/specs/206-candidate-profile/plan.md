...
Implement the candidate profile specification for the candidate portal domain with contract-first validation, RBAC enforcement, and append-only audit coverage.
...
### Task 1: Model CandidateProfile and EmergencyContact

**Complexity**: L
**Priority**: P0

**Description**: Finalize canonical data structures, validation rules, and ownership boundaries for candidate profile.
...
**Description**: Implement the request and response contracts for GET /api/v1/candidate/profile, PATCH /api/v1/candidate/profile, POST /api/v1/candidate/profile/emergency-contacts.
...
### Task 4: Implement candidate profile verification lifecycle
...
| interactions.yaml | Yes | Publishes Candidate Profile Verification Lifecycle transitions |
...
| --- | --- | --- |
| Phase 1 | 1-2 days | Model CandidateProfile and EmergencyContact, Deliver core API surface, Enforce RBAC and data scoping |
| Phase 2 | 2-3 days | Implement candidate profile verification lifecycle, Wire audit events, Add validation and regression coverage |
