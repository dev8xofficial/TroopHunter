...
export interface IUpdateUserNameSuccessPayload {
  request: IApiRequestAttributes<IUserUpdateNameRequestPayloadAttributes, undefined, undefined, undefined>;
...
export interface IUpdateUserPasswordSuccessPayload {
  request: IApiRequestAttributes<IUserUpdatePasswordRequestPayloadAttributes, undefined, undefined, undefined>;
  response: ApiResponse<IUserAttributes>;
}
