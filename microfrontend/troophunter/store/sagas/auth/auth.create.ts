...
export interface IAuthRegisterSuccessPayload {
  request: IApiRequestAttributes<IUserCreateRequestAttributes, undefined, undefined, { navigate: NextRouter['push'] }>;
  response: ApiResponse<IUserAttributes>;
}

export type IAuthSendVerificationTokenPayload = ISendVerificationTokenAttributes;
