...
function* createLeadSaga({ payload }: { payload: ICreateLeadPayload }): Generator<StrictEffect, void, void> {
  try {
    const { userId, businessIds, title, search, businessDomain, categoryId, address, cityId, stateId, countryId, postalCodeId, phone, email, website, ratingId, reviews, timezoneId, sponsoredAd, businessCount } = payload;
...
export interface ICreateLeadSuccessPayload {
  request: IApiRequestAttributes<ICreateLeadPayload, ICreateLeadPayload, undefined, undefined>;
