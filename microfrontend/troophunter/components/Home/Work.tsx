              ...
              <div className="relative overflow-hidden grid rounded-[inherit] pt-[calc(var(--aspect-y)/var(--aspect-x)*100%)]">
                <div className="w-full left-0 top-2/4 absolute transform -translate-y-2/4">
                  <picture className="max-w-full leading-[0] block rounded-2xl">
                    ...
                    <img className="max-w-full m-0 object-cover w-full h-full rounded-[inherit]" src="https://a-us.storyblok.com/f/1017006/3720x2280/c7c8f88227/curtin-open-landscape-card.jpg/m/450x330/filters:quality(80)" alt="Placeholder" />
                  </picture>
                </div>
                <div className="h-auto grid transform -translate-y-2/4 -translate-x-2/4 left-2/4 top-2/4 absolute w-[69.4214876033%]">
                  <picture className="max-w-full leading-[0] block rounded-2xl row-start-1 -col-start-1 row-end-auto col-end-auto">
                    ...
                    <img className="max-w-full m-0 object-cover w-full h-full rounded-[inherit]" src="https://a-us.storyblok.com/f/1017006/1476x843/7c8bacd5b5/open-day-inner.jpg/m/312x178/filters:quality(80)" alt="Placeholder" />
                  </picture>
                </div>
              </div>
              ...
              <div className="relative overflow-hidden grid rounded-[inherit] pt-[calc(var(--aspect-y)/var(--aspect-x)*100%)]">
                <div className="w-full left-0 top-2/4 absolute transform -translate-y-2/4">
                  <picture className="max-w-full leading-[0] block rounded-[20px]">
                    ...
                    <img className="max-w-full m-0 object-cover w-full h-full rounded-[inherit]" src="https://a-us.storyblok.com/f/1017006/1864x2333/f75518e100/sussex-portrait-card.jpg/m/450x677/filters:quality(80)" alt="Placeholder" />
                  </picture>
                </div>
              </div>
              <div className="grid content-end md:h-full md:w-full md:left-0 md:bottom-0 md:absolute md:text-white">
              ...
              <div className="relative overflow-hidden grid rounded-[inherit] pt-[calc(var(--aspect-y)/var(--aspect-x)*100%)]">
                <div className="w-full left-0 top-2/4 absolute transform -translate-y-2/4">
                  <picture className="max-w-full leading-[0] block rounded-[20px]">
                    ...
                    <img className="max-w-full m-0 object-cover w-full h-full rounded-[inherit]" src="https://a-us.storyblok.com/f/1017006/1864x2803/5416277cd6/ferox-outer.jpg/m/450x677/filters:quality(80)" alt="Placeholder" />
                  </picture>
                </div>
                <div className="h-auto grid transform -translate-y-2/4 -translate-x-2/4 left-2/4 top-2/4 absolute w-[38.0281690141%]">
                  <picture className="max-w-full leading-[0] block rounded-[20px] row-start-1 -col-start-1 row-end-auto col-end-auto">
                    ...
                    <img className="max-w-full m-0 object-cover w-full h-full rounded-[inherit]" src="https://a-us.storyblok.com/f/1017006/1684x3630/aff95687f6/ferox-inner.jpg/m/171x369/filters:quality(80)" alt="Placeholder" />
                  </picture>
                </div>
              </div>
              <div className="grid content-end md:h-full md:w-full md:left-0 md:bottom-0 md:absolute md:text-white">
              ...
              <div className="relative overflow-hidden grid rounded-[inherit] pt-[calc(var(--aspect-y)/var(--aspect-x)*100%)]">
                <div className="w-full left-0 top-2/4 absolute transform -translate-y-2/4">
                  <picture className="max-w-full leading-[0] block rounded-[20px]">
                    ...
                    <img className="max-w-full m-0 object-cover w-full h-full rounded-[inherit]" src="https://a-us.storyblok.com/f/1017006/3720x2280/ac63614d7c/trails-outer.jpg/m/450x330/filters:quality(80)" alt="Placeholder" />
                  </picture>
                </div>
                <div className="h-auto grid transform -translate-y-2/4 -translate-x-2/4 left-2/4 top-2/4 absolute w-[69.4214876033%]">
                  <picture className="max-w-full leading-[0] block rounded-[20px] row-start-1 -col-start-1 row-end-auto col-end-auto">
                    ...
                    <img className="max-w-full m-0 object-cover w-full h-full rounded-[inherit]" src="https://a-us.storyblok.com/f/1017006/2582x1427/67a2757f6a/trailswa-video-landscape-frame.jpg/m/312x178/filters:quality(80)" alt="Placeholder" />
                  </picture>
                </div>
              </div>
              <div className="grid content-end md:h-full md:w-full md:left-0 md:bottom-0 md:absolute md:text-white">
