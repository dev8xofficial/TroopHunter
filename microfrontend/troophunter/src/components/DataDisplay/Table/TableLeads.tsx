...
import { type ILeadAttributes, type IUserAttributes } from '@repo/validator';
...
const encryptionKey = process.env.VITE_ENCRYPTION_KEY != null ? process.env.VITE_ENCRYPTION_KEY : 'AgE34bNmLB9wOThIJ2WR79/cmtMdjqCbpk61w/ucZnviE1Te0IY7c1e2G5qi42h+';
...
const Table: React.FC = (): JSX.Element => {
  ...
  return (
    <>
      <div className="flex w-full flex-1 flex-col bg-gray-100 dark:bg-charcoal-300">
        <div className="mx-auto flex w-full max-w-7xl flex-1 flex-col px-4 py-4 xl:px-8 xl:pb-4">
          {/* Table */}
          {userLeads.length > 0 ? (
            ...
            <div className="flex h-full flex-1 flex-col bg-inherit dark:bg-charcoal-200">
              <div className="flex h-full flex-1 flex-col items-center justify-center dark:bg-charcoal-300">
