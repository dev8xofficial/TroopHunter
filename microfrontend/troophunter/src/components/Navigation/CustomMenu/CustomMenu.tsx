        ...
        <Transition as={Fragment} enter="transition ease-out duration-100" enterFrom="transform opacity-0 scale-95" enterTo="transform opacity-100 scale-100" leave="transition ease-in duration-75" leaveFrom="transform opacity-100 scale-100" leaveTo="transform opacity-0 scale-95">
          <Menu.Items className="absolute right-0 z-10 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dark:divide-charcoal-100 dark:bg-charcoal-300 dark:text-white">
            ...
            <div className="py-1">
              ...
              <Menu.Item>
                {({ active }) => (
                  <a href="#" className={classNames(active ? 'bg-gray-100 text-gray-900 dark:bg-charcoal-300 dark:text-white dark:hover:bg-charcoal-400 dark:hover:text-primary-text' : 'text-gray-700 dark:text-white', 'block px-4 py-2 text-sm')}>
                    Support
                  </a>
                )}
              </Menu.Item>
