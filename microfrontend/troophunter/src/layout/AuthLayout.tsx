...
const AuthLayout: React.FC<AuthLayoutProps> = ({ children }: AuthLayoutProps): JSX.Element => {
  return (
    <>
      <div className="h-screen overflow-y-auto dark:bg-charcoal-300">
        <div className="flex min-h-full flex-1">
          <div className="flex flex-1 flex-col justify-center px-4 py-8 sm:px-6 lg:flex-none lg:px-20 xl:px-24 2xl:px-36">
