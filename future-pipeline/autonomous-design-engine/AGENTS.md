...
- **15 invariants, not 13.** If you see anything referencing fewer than 15 invariants, it's stale — invariants I14 (Sandbox Isolation) and I15 (Delivery Gate sequence) were added during Phase 4 specification. See `spec/11 §7`.
