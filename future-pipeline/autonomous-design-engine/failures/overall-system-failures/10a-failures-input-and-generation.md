...
**Level:** spec · **Severity:** Med · **Area:** Input
- **Description:** The Brief Comprehension step ([11 §6](../../spec/11-guardrails-and-invariants.md)) and the Generator's understanding of tone/goal are tuned on English-language briefs; a non-English or mixed-language brief risks misread intent, lost nuance, or silently defaulting to English-centric design conventions.
