...
- **Always** treat `microfrontend/ferrari` as the primary Next.js FSD microfrontend covered by this Codex file; **never** assume other microfrontends follow the same conventions without checking their own `AGENTS.md`.
