...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    function mergeCitiesByName(cityData, selectiveCities) {
      const mergedCities = [];
    
      cityData.forEach((allCity) => {
    ...
    const mergedData = mergeCitiesByName(cityData, selectiveCities);
    const orderedCities = _.orderBy(mergedData, ['gdpInBillionUsd'], ['desc']);
    await queryInterface.bulkInsert('Cities', orderedCities);
  },
