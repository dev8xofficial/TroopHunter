...
POSTGRES_HOST=${POSTGRES_HOST:-"postgres_businesses_dev"} # Use the value from .env or the default if not defined
POSTGRES_PORT=${POSTGRES_PORT:-"5440"}
POSTGRES_DB=${POSTGRES_DB:-"postgres_businesses_dev"}
