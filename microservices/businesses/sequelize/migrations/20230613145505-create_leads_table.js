...
module.exports = {
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.removeConstraint('Leads', 'unique_lead_user');
    await queryInterface.removeConstraint('Businesses', 'fk_lead_category');
    await queryInterface.removeConstraint('Leads', 'unique_lead_city');
    await queryInterface.removeConstraint('Leads', 'unique_lead_state');
    await queryInterface.removeConstraint('Leads', 'unique_lead_country');
