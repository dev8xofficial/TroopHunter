...
const privateKey = fs.readFileSync(path.resolve(__dirname, '../certs/leads-key.pem'));
const certificate = fs.readFileSync(path.resolve(__dirname, '../certs/leads-cert.pem'));
