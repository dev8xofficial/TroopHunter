...
const privateKey = fs.readFileSync(path.resolve(__dirname, '../certs/cities-key.pem'));
const certificate = fs.readFileSync(path.resolve(__dirname, '../certs/cities-cert.pem'));
