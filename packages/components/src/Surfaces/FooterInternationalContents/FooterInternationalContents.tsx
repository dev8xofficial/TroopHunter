    ...
    <>
      ...
      <div className={`${styles['footer-bottom']} footer-bottom`}>
        <div className={styles['footer-legal']}>
          ...
          {!isMounted ? (
            // Server-side render: show dev8x logo to prevent hydration mismatch
            ...
            <svg height="32" viewBox="0 0 773 240" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '60px', height: '32px' } as React.CSSProperties}>
              <path
                ...
                fill="currentColor"
              />
              <path d="M134 195H103.077L67.1393 83.0626H66.8607L30.9231 195H0L50.4241 52L83.5759 52L134 195Z" fill="currentColor" />
              <path d="M67.1393 182.967C56.8316 182.967 49.0312 175.971 49.0312 164.777C49.0312 153.863 56.8316 146.587 67.1393 146.587C77.1684 146.587 84.9688 153.863 84.9688 164.777C84.9688 175.971 77.1684 182.967 67.1393 182.967Z" fill="currentColor" />
            </svg>
          ) : (
            // dev8x logo
            <svg width="60" viewBox="0 0 224 77" fill="none" xmlns="http://www.w3.org/2000/svg">
