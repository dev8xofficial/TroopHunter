        ...
        <div className={styles['footer-columns__column']}>
          <div className={styles['flex-row']}>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 16 16" className="" style={{ '--width': 16, '--height': 16 } as React.CSSProperties}>
              <path stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="0.64" d="M.8 8a7.2 7.2 0 1 0 14.4 0A7.2 7.2 0 0 0 .8 8Z"></path>
              <path stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="0.64" d="M6.643 15.072c-1.005-1.408-1.683-4.051-1.683-7.04S5.638 2.336 6.643.96M9.357 15.072c1.005-1.408 1.683-4.051 1.683-7.04S10.362 2.336 9.357.96M.8 8h14.4M1.632 11.36h12.736M1.632 4.64h12.736"></path>
            </svg>
          ...
          <div>
            <button className={`${ContactFormModalStyles['contact-form-button']} ${styles['footer-contact-button']}`} data-international-footer-cta="true" data-faitracker-form-bind="true">
              Submit a brief
              <svg xmlns="http://www.w3.org/2000/svg" width="12" height="13" fill="none" stroke-width="0.5" viewBox="0 0 14 13" className="" style={{ '--width': 12, '--height': 13 } as React.CSSProperties}>
        ...
        <ul className={styles['footer-socials']}>
          <li className={styles['footer-socials__item']}>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="13" height="14" fill="none" viewBox="0 0 13 14" className={styles['footer-socials__separator']} style={{ '--width': 13, '--height': 14 } as React.CSSProperties}>
              <path fill="currentColor" fill-rule="evenodd" d="M7.121.87H5.874v4.123L2.96 2.078l-.882.882 2.92 2.919H.864v1.247h4.133l-2.919 2.919.882.882 2.913-2.913v4.122h1.247V8.004l2.923 2.923.882-.882-2.919-2.919h4.125V5.88H8.009l2.919-2.919-.882-.882-2.925 2.925V.869Z" clip-rule="evenodd"></path>
            </svg>
          </li>
          <li className={styles['footer-socials__item']}>
