...
export const ICON_MAP: Record<string, (size: number) => JSX.Element> = {
  ...
  PointerIcon: (size) => <PointerIcon size={size} />,
  ...
  MyspaceIcon: (size) => <MyspaceIcon size={size} />,
  ...
  AIBrainIcon: (size) => <AIBrainIcon size={size} />,
