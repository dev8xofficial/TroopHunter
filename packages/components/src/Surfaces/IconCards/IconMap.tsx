...
// Create base icon map
const baseIconMap: Record<string, (size: number) => JSX.Element> = {
  AccessibilityIcon: (size) => <AccessibilityIcon size={size} />,
  AdobeIcon: (size) => <AdobeIcon size={size} />,
  AgileDeliveryIcon: (size) => <AgileDeliveryIcon size={size} />,
  AnalysisIcon: (size) => <AnalysisIcon size={size} />,
  AnalyticsIcon: (size) => <AnalyticsIcon size={size} />,
  AnsibleIcon: (size) => <AnsibleIcon size={size} />,
  ArchitectureIcon: (size) => <ArchitectureIcon size={size} />,
  AsteriskIcon: (size) => <AsteriskIcon size={size} />,
  AuthenticationIcon: (size) => <AuthenticationIcon size={size} />,
  AuthorizationIcon: (size) => <AuthorizationIcon size={size} />,
  AwsIcon: (size) => <AwsIcon size={size} />,
  BackendIcon: (size) => <BackendIcon size={size} />,
  BasketIcon: (size) => <BasketIcon size={size} />,
  BrainIcon: (size) => <BrainIcon size={size} />,
  CanvaIcon: (size) => <CanvaIcon size={size} />,
  CardIcon: (size) => <CardIcon size={size} />,
  CaretDownIcon: (size) => <CaretDownIcon width={size} height={size} />,
  CaretUpIcon: (size) => <CaretUpIcon width={size} height={size} />,
  ClickUpIcon: (size) => <ClickUpIcon size={size} />,
  CoinsIcon: (size) => <CoinsIcon size={size} />,
  CollabSpaceIcon: (size) => <CollabSpaceIcon size={size} />,
  CreditCardIcon: (size) => <CreditCardIcon size={size} />,
  CrossIcon: (size) => <CrossIcon size={size} />,
  DartIcon: (size) => <DartIcon size={size} />,
  DataIcon: (size) => <DataIcon size={size} />,
  DatabaseIcon: (size) => <DatabaseIcon size={size} />,
  DataBaseOptimizationIcon: (size) => <DataBaseOptimizationIcon size={size} />,
  DentistIcon: (size) => <DentistIcon size={size} />,
  DevicesIcon: (size) => <DevicesIcon size={size} />,
  DockerIcon: (size) => <DockerIcon size={size} />,
  EditIcon: (size) => <EditIcon size={size} />,
  EndTestingIcon: (size) => <EndTestingIcon size={size} />,
  EyeIcon: (size) => <EyeIcon size={size} />,
  FaceIdIcon: (size) => <FaceIdIcon size={size} />,
  ...
  GitlabIcon: (size) => <GitlabIcon size={size} />,
  GitPullIcon: (size) => <GitPullIcon size={size} />,
  GlobeIcon: (size) => <GlobeIcon size={size} />,
  GoogleAnalyticsIcon: (size) => <GoogleAnalyticsIcon size={size} />,
  GPSIcon: (size) => <GPSIcon size={size} />,
  GraduateHatIcon: (size) => <GraduateHatIcon size={size} />,
  GraphAnalysisIcon: (size) => <GraphAnalysisIcon size={size} />,
  GraphQLIcon: (size) => <GraphQLIcon size={size} />,
  GroupUsersIcon: (size) => <GroupUsersIcon size={size} />,
  GsapIcon: (size) => <GsapIcon size={size} />,
  HandPalmIcon: (size) => <HandPalmIcon size={size} />,
  HandshakeIcon: (size) => <HandshakeIcon size={size} />,
  HeartIcon: (size) => <HeartIcon size={size} />,
  HighAvailabiltyIcon: (size) => <HighAvailabiltyIcon size={size} />,
  HomeIcon: (size) => <HomeIcon size={size} />,
  HotjarIcon: (size) => <HotjarIcon size={size} />,
  HtmlIcon: (size) => <HtmlIcon size={size} />,
  HubspotIcon: (size) => <HubspotIcon size={size} />,
  InfinityIcon: (size) => <InfinityIcon size={size} />,
  JenkinsIcon: (size) => <JenkinsIcon size={size} />,
  KubernetesIcon: (size) => <KubernetesIcon size={size} />,
  LaptopIcon: (size) => <LaptopIcon size={size} />,
  LaravelIcon: (size) => <LaravelIcon size={size} />,
  LightningIcon: (size) => <LightningIcon size={size} />,
  LoadTestingIcon: (size) => <LoadTestingIcon size={size} />,
  MagicWandIcon: (size) => <MagicWandIcon size={size} />,
  MailchimpIcon: (size) => <MailchimpIcon size={size} />,
  MaintenanceIcon: (size) => <MaintenanceIcon size={size} />,
  MapIcon: (size) => <MapIcon size={size} />,
  MobileIcon: (size) => <MobileIcon size={size} />,
  MonitorIcon: (size) => <MonitorIcon size={size} />,
  MonoRepoArchitectureIcon: (size) => <MonoRepoArchitectureIcon size={size} />,
  NestjsIcon: (size) => <NestjsIcon size={size} />,
  NextjsIcon: (size) => <NextjsIcon size={size} />,
  NodejsIcon: (size) => <NodejsIcon size={size} />,
  OpenBookIcon: (size) => <OpenBookIcon size={size} />,
  OwnershipIcon: (size) => <OwnershipIcon size={size} />,
  PaintSwatchIcon: (size) => <PaintSwatchIcon size={size} />,
  PayPalIcon: (size) => <PayPalIcon size={size} />,
  PerformanceOptimizationIcon: (size) => <PerformanceOptimizationIcon size={size} />,
  PieChartIcon: (size) => <PieChartIcon size={size} />,
  PlanetRingIcon: (size) => <PlanetRingIcon size={size} />,
  PointerCursorIcon: (size) => <PointerCursorIcon size={size} />,
  PostgresqlIcon: (size) => <PostgresqlIcon size={size} />,
  PrettierIcon: (size) => <PrettierIcon size={size} />,
  PuzzlePieceIcon: (size) => <PuzzlePieceIcon size={size} />,
  QAIcon: (size) => <QAIcon size={size} />,
  RapidDeliveryIcon: (size) => <RapidDeliveryIcon size={size} />,
  ReactjsIcon: (size) => <ReactjsIcon size={size} />,
  ReduxIcon: (size) => <ReduxIcon size={size} />,
  RefreshIcon: (size) => <RefreshIcon size={size} />,
  ResponsiveIcon: (size) => <ResponsiveIcon size={size} />,
  RestApiIcon: (size) => <RestApiIcon size={size} />,
  RightArrowIcon: (size) => <RightArrowIcon size={size} />,
  RocketIcon: (size) => <RocketIcon size={size} />,
  SaaSIcon: (size) => <SaaSIcon size={size} />,
  ScaleIcon: (size) => <ScaleIcon size={size} />,
  SecureIntegrationsIcon: (size) => <SecureIntegrationsIcon size={size} />,
  SecurityIcon: (size) => <SecurityIcon size={size} />,
  SeismometerIcon: (size) => <SeismometerIcon size={size} />,
  SelectionIcon: (size) => <SelectionIcon size={size} />,
  SeleniumIcon: (size) => <SeleniumIcon size={size} />,
  SequelizeIcon: (size) => <SequelizeIcon size={size} />,
  ShieldIcon: (size) => <ShieldIcon size={size} />,
  ShoppingBagIcon: (size) => <ShoppingBagIcon size={size} />,
  ShoppingCartIcon: (size) => <ShoppingCartIcon size={size} />,
  ShuffleIcon: (size) => <ShuffleIcon size={size} />,
  SlackIcon: (size) => <SlackIcon size={size} />,
  SmileIcon: (size) => <SmileIcon size={size} />,
  SparklerIcon: (size) => <SparklerIcon size={size} />,
  SquiggleIcon: (size) => <SquiggleIcon size={size} />,
  StarIcon: (size) => <StarIcon size={size} />,
  StripeIcon: (size) => <StripeIcon size={size} />,
  SupabaseIcon: (size) => <SupabaseIcon size={size} />,
  SupportIcon: (size) => <SupportIcon size={size} />,
  TailwindIcon: (size) => <TailwindIcon size={size} />,
  TargetIcon: (size) => <TargetIcon size={size} />,
  TerraformIcon: (size) => <TerraformIcon size={size} />,
  TestingIcon: (size) => <TestingIcon size={size} />,
  TubroRepoIcon: (size) => <TubroRepoIcon size={size} />,
  TypeScriptIcon: (size) => <TypeScriptIcon size={size} />,
  UnitTestingIcon: (size) => <UnitTestingIcon size={size} />,
  UserIcon: (size) => <UserIcon size={size} />,
  UserIdIcon: (size) => <UserIdIcon size={size} />,
  VirtualMachinesIcon: (size) => <VirtualMachinesIcon size={size} />,
  VoltageIcon: (size) => <VoltageIcon size={size} />,
  WandIcon: (size) => <WandIcon size={size} />,
  WebServersIcon: (size) => <WebServersIcon size={size} />,
  WordpressIcon: (size) => <WordpressIcon size={size} />
};

export const ICON_MAP: Record<string, (size: number) => JSX.Element> = baseIconMap;