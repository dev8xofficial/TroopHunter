...
export const ICON_MAP: Record<string, (width: number) => JSX.Element> = {
  ...
  BackendIcon: (width) => <BackendIcon width={width} />,
  MonitorIcon: (width) => <MonitorIcon width={width} />,
  PieChartIcon: (width) => <PieChartIcon width={width} />,
  PointerIcon: (width) => <PointerIcon width={width} />,
  VoltageIcon: (width) => <VoltageIcon width={width} />,
  CardIcon: (width) => <CardIcon width={width} />,
  DevicesIcon: (width) => <DevicesIcon width={width} />,
  GlobeIcon: (width) => <GlobeIcon width={width} />,
  GPSIcon: (width) => <GPSIcon width={width} />,
  ShieldIcon: (width) => <ShieldIcon width={width} />,
  PuzzlePieceIcon: (width) => <PuzzlePieceIcon width={width} />,
  SaaSIcon: (width) => <SaaSIcon width={width} />,
  VirtualMachinesIcon: (width) => <VirtualMachinesIcon width={width} />,
  AnalysisIcon: (width) => <AnalysisIcon width={width} />,
  FourDotIcon: (width) => <FourDotIcon width={width} />,
  MyspaceIcon: (width) => <MyspaceIcon width={width} />,
  SparklerIcon: (width) => <SparklerIcon width={width} />,
  WandIcon: (width) => <WandIcon width={width} />,
  HandPalmIcon: (width) => <HandPalmIcon width={width} />,
  PaintSwatchIcon: (width) => <PaintSwatchIcon width={width} />,
  SelectionIcon: (width) => <SelectionIcon width={width} />,
  FaceIdIcon: (width) => <FaceIdIcon width={width} />,
  InfinityIcon: (width) => <InfinityIcon width={width} />,
  LaptopIcon: (width) => <LaptopIcon width={width} />,
  MobileIcon: (width) => <MobileIcon width={width} />,
  ShuffleIcon: (width) => <ShuffleIcon width={width} />,
  BasketIcon: (width) => <BasketIcon width={width} />,
  ShoppingBagIcon: (width) => <ShoppingBagIcon width={width} />,
  ShoppingCartIcon: (width) => <ShoppingCartIcon width={width} />,
  UserIcon: (width) => <UserIcon width={width} />,
  DataIcon: (width) => <DataIcon width={width} />,
  EyeIcon: (width) => <EyeIcon width={width} />,
  MapIcon: (width) => <MapIcon width={width} />,
  SeismometerIcon: (width) => <SeismometerIcon width={width} />,
  FrameIcon: (width) => <FrameIcon width={width} />,
  MagicWandIcon: (width) => <MagicWandIcon width={width} />,
  TargetIcon: (width) => <TargetIcon width={width} />,
  PlanetRingIcon: (width) => <PlanetRingIcon width={width} />,
  HandshakeIcon: (width) => <HandshakeIcon width={width} />,
  ReactjsIcon: (width) => <ReactjsIcon width={width} />,
  LightningIcon: (width) => <LightningIcon width={width} />,
  NextjsIcon: (width) => <NextjsIcon width={width} />,
  NodejsIcon: (width) => <NodejsIcon width={width} />,
  NestjsIcon: (width) => <NestjsIcon width={width} />,
  WebServersIcon: (width) => <WebServersIcon width={width} />,
  PostgresqlIcon: (width) => <PostgresqlIcon width={width} />,
  SupabaseIcon: (width) => <SupabaseIcon width={width} />,
  GraphAnalysisIcon: (width) => <GraphAnalysisIcon width={width} />,
  GroupUsersIcon: (width) => <GroupUsersIcon width={width} />,
  HeartIcon: (width) => <HeartIcon width={width} />,
