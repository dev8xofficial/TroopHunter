...
export const ExpertiseCard: React.FC<Omit<ExpertiseContent, 'meta' | 'iconCards' | 'contentAsideImageItems' | 'footerMainContent' | 'footerForm' | 'footerSocialLinks' | 'testimonials'>> = ({ variant, tagText, heading, slug, image }): JSX.Element => {
  return (
    <>
