...
import { Button, ExpertiseContent } from '@repo/components';

import PictureStyles from '../Picture/index.module.css';
import styles from './index.module.css';

export const ExpertiseCard: React.FC<Omit<ExpertiseContent, 'slug' | 'iconCards' | 'contentAsideImageItems' | 'footerMainContent' | 'footerForm' | 'footerSocialLinks' | 'testimonials'>> = ({ variant, tagText, heading }): JSX.Element => {
  return (
    <>
