...
export const ExpertiseCard: React.FC<Omit<ExpertiseContent, 'meta' | 'iconCards' | 'contentAsideImageItems' | 'footerMainContent' | 'footerData' | 'footerSocialLinks' | 'testimonials'>> = ({ variant, tagText, heading, slug, image }): JSX.Element => {
  return (
    <>
