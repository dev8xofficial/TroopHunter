...
const FlutterIcon: React.FC<FlutterIconProps> = ({ size = 24, className }) => {
  return (
    <svg width={size} height={size} className={className} viewBox="0 0 54 66" fill="none" xmlns="http://www.w3.org/2000/svg">
