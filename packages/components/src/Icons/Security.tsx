...
const SecurityIcon: React.FC<SecurityIconProps> = ({ size = 24, className }) => {
  return (
    <svg width={size} height={size} viewBox="0 0 59 70" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
