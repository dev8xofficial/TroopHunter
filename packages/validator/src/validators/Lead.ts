...
export const LeadsFetchByUserIdRequestSchema = LeadSchema.pick({ userId: true });
...
export const LeadsFetchByUserIdRequestValidationMiddleware = validationMiddleware(LeadsFetchByUserIdRequestSchema, 'params');
