...
// Paths for microfrontend troophunter
const PUBLIC_DIR = path.resolve('../../microfrontend/troophunter/public');
const NEXT_STATIC_DIR = path.resolve('../../microfrontend/troophunter/.next/static');
