...
// Paths for microfrontend helloabdul
const PUBLIC_DIR = path.resolve('../../microfrontend/helloabdul/public');
const NEXT_STATIC_DIR = path.resolve('../../microfrontend/helloabdul/.next/static');
