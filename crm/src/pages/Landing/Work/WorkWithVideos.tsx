            ...
            <a className="bg-transparent rounded-[clamp(1.25rem,1.3227513228vw,1.6625rem)] text-[inherit] no-underline relative w-full block lg:rounded-[clamp(1.875rem,1.9841269841vw,2.49375rem)]">
              <div className="relative overflow-hidden grid rounded-[inherit] pt-[calc(var(--aspect-y)/var(--aspect-x)*100%)]">
                ...
                <div className="h-auto grid transform -translate-y-2/4 -translate-x-2/4 left-2/4 top-2/4 absolute w-[69.4214876033%] items-center">
                  ...
                  <video className="rounded-inherit z-0 aspect-square row-start-1 col-start-1 row-end-auto col-end-auto w-auto object-center object-contain" src={`${import.meta.env.VITE_TROOPHUNTER_PUBLIC_URL}/videos/troophunter/light/search.mp4`} preload="none" loop controls={false} autoPlay muted playsInline></video>
                </div>
              </div>
            ...
            <a className="bg-transparent rounded-[clamp(1.25rem,1.3227513228vw,1.6625rem)] text-[inherit] no-underline relative w-full block lg:rounded-[clamp(1.875rem,1.9841269841vw,2.49375rem)]">
              <div className="relative overflow-hidden grid rounded-[inherit] pt-[calc(var(--aspect-y)/var(--aspect-x)*100%)]">
                ...
                <div className="h-auto grid transform -translate-y-2/4 -translate-x-2/4 left-2/4 top-2/4 absolute w-[38.0281690141%]">
                  ...
                  <video className="rounded-inherit z-0 aspect-square row-start-1 col-start-1 row-end-auto col-end-auto h-full scale-[1.15] object-center object-contain" src={`${import.meta.env.VITE_TROOPHUNTER_PUBLIC_URL}/videos/troophunter/light/sort.mp4`} preload="none" loop controls={false} autoPlay muted playsInline></video>
                </div>
              </div>
              <div className="grid content-end md:h-full md:w-full md:left-0 md:bottom-0 md:absolute">
                <div className="grid p-[clamp(.75rem,.7936507937vw,.9975rem)_0_0] md:bottom-0 md:sticky md:p-[clamp(1.5rem,1.5873015873vw,1.995rem)_clamp(1.875rem,1.9841269841vw,2.49375rem)]">
            ...
            <a className="bg-transparent rounded-[clamp(1.25rem,1.3227513228vw,1.6625rem)] text-[inherit] no-underline relative w-full block lg:rounded-[clamp(1.875rem,1.9841269841vw,2.49375rem)]">
              <div className="relative overflow-hidden grid rounded-[inherit] pt-[calc(var(--aspect-y)/var(--aspect-x)*100%)]">
                ...
                <div className="h-auto grid transform -translate-y-2/4 -translate-x-2/4 left-2/4 top-2/4 absolute w-[38.0281690141%]">
                  ...
                  <video className="rounded-inherit z-0 aspect-square row-start-1 col-start-1 row-end-auto col-end-auto h-full scale-[1.15] object-center object-contain" src={`${import.meta.env.VITE_TROOPHUNTER_PUBLIC_URL}/videos/troophunter/light/call.mp4`} preload="none" loop controls={false} autoPlay muted playsInline></video>
                </div>
              </div>
              <div className="grid content-end md:h-full md:w-full md:left-0 md:bottom-0 md:absolute">
                <div className="grid p-[clamp(.75rem,.7936507937vw,.9975rem)_0_0] md:bottom-0 md:sticky md:p-[clamp(1.5rem,1.5873015873vw,1.995rem)_clamp(1.875rem,1.9841269841vw,2.49375rem)]">
