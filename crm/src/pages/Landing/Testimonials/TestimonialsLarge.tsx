...
const TestimonialsLarge: React.FC = (): JSX.Element => {
  return (
    <>
      <div className="text-[var(--theme-secondary)] m-[clamp(7.5rem,15.625vw,9.975rem)_auto] w-auto box-content pb-[50vh] content-center items-center grid-template-areas-heading-columns grid px-[var(--container-gutter)] max-w-[calc(clamp(89.5rem,94.708994709vw,119.035rem)+var(--container-gutter)*2)] lg:my-[clamp(17.5rem,18.5185185185vw,23.275rem)] lg:h-auto">
        <h2 className="font-medium mt-0 mb-[clamp(5rem,10.4166666667vw,6.65rem)] text-[clamp(2.1875rem,4.5572916667vw,2.909375rem)] leading-[1] mx-auto max-w-[clamp(78.75rem,83.3333333333vw,104.7375rem)] text-left lg:text-center lg:mb-[clamp(7.5rem,7.9365079365vw,9.975rem)] lg:text-[clamp(6.25rem,6.6137566138vw,8.3125rem)]">We create, enhance, and deliver top-notch lead generation solutions for innovative businesses.</h2>
