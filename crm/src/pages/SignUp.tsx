    ...
    <>
      <div>
        ...
        <p className="mt-2 text-sm leading-6 text-gray-500">
          Already a member?{' '}
          <Link to="/signin" className="font-semibold text-indigo-600 hover:text-indigo-600">
            Sign in now
          </Link>
        </p>
      </div>
      ...
      <div className="mt-10">
        ...
        <div className="mt-10">
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            <a href="#" className="flex w-full items-center justify-center gap-3 rounded bg-[#1D9BF0] px-3 py-1.5 text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1D9BF0]">
            ...
            <a href="#" className="flex w-full items-center justify-center gap-3 rounded bg-[#24292F] px-3 py-1.5 text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#24292F]">
              <svg className="h-5 w-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                <path
                  fillRule="evenodd"
