...
const SettingsProfile: React.FC = (): JSX.Element => {
  ...
  return (
    <SettingsLayout>
      <dl className="mt-6 space-y-6 divide-y divide-gray-100 border-t border-gray-200 text-sm leading-6 dark:border-charcoal-100">
              ...
              <dd className="mt-1 flex justify-between gap-x-6 sm:mt-0 sm:flex-auto">
                <div>
                  <div className="col-span-full flex items-center gap-x-8">
                    ...
                    <div>
                      <button type="button" className="rounded border border-indigo-600 bg-white/10 px-3 py-2 text-sm font-semibold text-indigo-600 shadow-sm hover:bg-indigo-600 hover:text-white dark:bg-transparent dark:text-white">
                        Change avatar
                      </button>
