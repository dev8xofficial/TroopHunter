  ...
  return (
    <SettingsLayout>
      <Helmet>
        ...
        <link rel="canonical" href={`${import.meta.env.VITE_TROOPHUNTER_PUBLIC_URL}/settings/security`} />
        ...
        <meta property="og:url" content={`${import.meta.env.VITE_TROOPHUNTER_PUBLIC_URL}/settings/security`} />
