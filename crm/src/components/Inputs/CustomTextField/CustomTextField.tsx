  ...
  return (
    <div className="relative w-full">
      ...
      <div className="mt-2 flex rounded-md shadow-sm">
        ...
        <button type="button" className="relative -ml-px inline-flex items-center gap-x-1.5 rounded-r-md px-3 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50" onClick={handleClearInput}>
