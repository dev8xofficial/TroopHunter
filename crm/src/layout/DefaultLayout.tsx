...
import { BellIcon, PresentationChartLineIcon, QueueListIcon, UserIcon, XMarkIcon } from '@heroicons/react/24/outline';
        ...
        <Disclosure as="nav" className="border-b border-gray-700 bg-gray-800">
          {() => (
            <>
              ...
              <div className="btm-nav z-20 h-16 bg-white shadow xl:hidden">
