...
import { IBusinessSocialMediaAttributes } from 'validator/interfaces/BusinessSocialMedia';

class BusinessSocialMedia extends Model<IBusinessSocialMediaAttributes> implements IBusinessSocialMediaAttributes {
  public id!: string;
