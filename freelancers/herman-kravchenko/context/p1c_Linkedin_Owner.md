...
profile_type: person
name: Herman K.
headline: Helping advertisement agencies to launch MVPs 40% Faster. Get your MVP running in a matter of weeks!
location: Edmonton, Alberta, Canada
connections: 500+
---

# Herman K. — LinkedIn Profile

## Summary

Did you know that 68% of MVPs fail within months of launch? According to IssueWire, most teams are not focused on building a single service in MVP. Budgets blow up. Deadlines slip.

I'm Herman, CEO of Coding House Studio. We help advertising agencies and small to mid-size businesses launch MVPs the right way — fast, focused, and without compromise on the quality. We build products that are ready to grow, focused on the features that matter most, and designed to get your idea in front of real users as quickly as possible. We help reduce time to market by 40% compared to traditional alternatives by focusing strictly on high-impact MVP features.
...
Our clients rely on us for transparency and trust us to deliver their projects the right way. We help you figure out what your MVP needs right now — and what can wait.

## Experience

#### CEO & Founder — Coding House Studio

dates: Sep 2025 – Present
duration: 10 mos
location: Wilmington, Delaware, United States
employment_type: Self-employed, Remote

As CEO of Coding House, my mission is simple: help businesses stay competitive in the age of AI. I founded Coding House to bring creativity back into development. I surrounded myself with experts who share that same passion for innovation — people who push boundaries, embrace new ideas, and deliver work that actually moves the needle for our clients.

#### Agile Team Lead — AMA - Alberta Motor Association

dates: Jan 2024 – Aug 2025
duration: 1 yr 8 mos
location: Edmonton, Alberta, Canada
employment_type: Permanent Full-time, Hybrid

- Led and mentored a team of 5 full-stack mobile developers, focusing on personal growth and skill development.
- Unblocked development team by introducing integration testing and a new state management approach.
...
#### Network Architect — Nicholas and Company
...
#### Cloud Solutions Specialist — JourneyTEAM
...
#### Information Security Specialist — Progressive Leasing
...
| Title | Company | Dates |
| ----- | ------- | ----- |
| Senior Technical Service Representative | ExpanDrive and others | Mar 2018 – Jan 2020 |
| Metadata Specialist | FamilySearch | Oct 2016 – Sep 2017 |
...
- **Certified Scrum Professional® - ScrumMaster** — Scrum Alliance — ~1 yr ago
- **Advanced Certified ScrumMaster® (A-CSM)** — Scrum Alliance — ~1 yr ago
- **Scrum Master Certified (SMC)** — Scrum Alliance — ~1 yr ago
- **AWS Certified Cloud Practitioner** — Amazon Web Services — ~1 yr ago

## Recommendations

#### Recommendation from Bridget Regan

relationship: Startup Founder & Operator — Herman's client
...
#### Recommendation from Spencer Leigh

relationship: Service Desk Analyst — peer, same seniority level
date: May 7, 2023

I found Herman to be a very valuable resource. He is a very intelligent and driven individual. Any time my team had a question he would either know the answer or would be able to find it in a time efficient manner. Herman is a self motivator and someone that can always be counted on to get the job done.

#### Recommendation from Jared S.

relationship: Information Security Professional at Progressive Leasing — managed Herman directly
date: April 24, 2020
...
#### Recommendation from Bryan Swainston

relationship: Cybersecurity Architect — senior to Herman
date: April 3, 2020
...
People don't talk about the partner question enough. A good development partner won't just take your spec and start building. They'll ask why mobile, why now, why this feature set and not a leaner one. They'll push back, not to slow you down, but because they've seen what happens when nobody does.
...
It's almost never really about the technology.
...
external_link: https://lnkd.in/g-xAANyN
