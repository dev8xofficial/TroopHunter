...
platform: LinkedIn
profile_type: person
name: Amish Maqbool Khan
headline: "✨✨ Transforming Logic into Magic ✨✨ Creator | Entrepreneur | Mentor | Front-End & Full-Stack Software Engineer | Technical Architect | AI Engineer | Engineering & Product Leader | Empowering & Building Digital Solutions"
location: Canada
followers: 1,702
connections: 500+
website: https://upwork.com (Upwork profile linked in contact info)
...
# Amish Maqbool Khan — LinkedIn Profile
...
#### UI/UX Designer / Full Stack Developer / Frontend Software Engineer / Top-Rated Plus / AI Engineer — Upwork
...
#### Senior Software Consultant — QuickNode
...
- Developed and deployed innovative new features aligned with QuickNode's strategic roadmap, ensuring a consistent, user-friendly, and engaging experience across all touchpoints.
...
- Collaborated with cross-functional teams — designers, developers, and product managers — to identify and capitalize on opportunities for platform innovation and continuous improvement.
...
- Monitored and implemented best practices for SEO and performance optimization.
- Engaged in continuous learning to stay current with the latest frontend technologies, design trends, and CMS management techniques.

---

#### Chief Front-End Engineer — Nexlayer
...
#### Founder & Software Consultant — Stellar Stack
...
#### Senior Frontend Software Engineer — Agile IT
...
Working as Web Developer with experience in Astro to assist in the migration, redesign, and redevelopment, maintenance, and updating of an existing WordPress site.

Key Responsibilities:

- Complete migration of website from WordPress to latest tech stack.
- Updating and maintaining the existing website in Astro, ensuring optimal performance and user experience.
- Integrating a WYSIWYG service to facilitate the building of new pages, while ensuring full compatibility with Astro.
- Ensuring all design components are developed using Tailwind CSS, allowing for easy global and specific design modifications.
- Working closely with design and content teams to ensure website aesthetics and functionality align with company goals.
- Continuously testing and debugging to ensure the website remains responsive across devices and browsers.
- Staying updated with the latest developments in Astro and related technologies.
- Collaborating and communicating daily or weekly with stakeholders and other team members.

---

#### Tech Lead / Senior Frontend Software Engineer — Crowdbotics
...
#### Full Stack Engineer & Lead Senior Frontend Engineer — Intelligent Relations

dates: Apr 2022 – Mar 2023
duration: 1 yr
location: Weston, Connecticut · Remote
employment_type: Contract Full-time

IR — a growing, 100% virtual MarTech SaaS startup. Responsibilities included implementation of a library of React components and page designs, as well as:

- Backend: Working with TypeScript, NodeJS, BlitzJS for server-side development.
- Frontend: Working with React for client-side development.
- Working with a utility-first CSS framework like TailwindCSS.
- Working with Strapi or other headless CMS for dynamic content generation for landing pages.
- Working with Prisma Studio, PostgreSQL database.
- Designing features from scratch and refactoring and proposing improvements for existing functionalities.

---

#### Full Stack Engineer — ngrok
...
Project to convert Figma designs into HTML/Tailwind/JS in marketing and blog sites, working seamlessly with existing tech (static pages with Python/Flask/HTML/CSS/Markdown). Developed a Blog web App as a JAMStack proposal (React + CMSless solution).

- Experience converting static sites from Python/Flask to JAMStack.
- Experience making architectural recommendations.
- Experience with Git source control and CMSless solutions.

---

#### Senior Frontend Developer — Leni
...
Built a digital solution for rental managers that automates and orients operations with the power of data (Realsage platform). Combined deep experience from real estate (JLL, Cushman & Wakefield, Greybook) and banking/technology (Goldman Sachs, RBC, Zomato).

Platform outcomes:
- Over 2,000 subscribed units
...
| Title | Company | Dates |
| ----- | ------- | ----- |
| Senior Frontend Software Engineer | FHA Technology | Dec 2020 – Jan 2021 |
| Software Engineer | elTallerJS | Jun 2020 – Nov 2020 |
| Frontend React Engineer | AlphaSquad | Jan 2019 – Aug 2020 |
| Frontend Web Developer | SeerBytes | Jan 2018 – Dec 2018 |
...
#### Recommendation from Salvador S.

relationship: Founder & CEO at Nexlayer — client
...
#### Recommendation from Sean Madden

relationship: Marketing Operations / Revenue Operations Leader — managed Amish directly
date: June 5, 2025
...
Drop your thoughts or suggestions in our Discord support channel.

Your feedback will help us shape the next version of NexLayer 🚀
Thanks for the support 🙌

external_link: https://nexlayer.io
...
type: original
timestamp: 11mo
hashtags: [#NexLayer, #v1, #SaaS, #CloudComputing, #DevTools, #AI, #StartupLaunch, #EarlyAccess, #TechCommunity, #FeedbackWanted, #ProductLaunch]
...
external_link: https://nexlayer.com
...
type: original
timestamp: 1yr
hashtags: [#AI, #SoftwareDevelopment, #AgenticEngineering, #NexLayer, #Developers, #TechInnovation, #ComingSoon]
...
👀 We're calling on bold, visionary developers, Engineers, Freelancers to test-drive the future and help shape the next evolution of AI-powered engineering.

⚡ Early access is limited! Want in? Drop a comment, DM us, or secure your spot here: Currently in alpha.

🚀 Let's build the future—together.

external_link: https://nexlayer.com (alpha signup)
...
type: repost
timestamp: 1yr
hashtags: [#AI, #SoftwareDevelopment, #AgenticEngineering, #NexLayer, #Developers, #TechInnovation]

Reposted from Salvador S.
